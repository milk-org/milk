...
{
    if (0 + CLI_checkarg(1, CLIARG_STR_NOT_IMG) + CLI_checkarg(2, CLIARG_FLOAT64) == 0)
    {
...
{
    RegisterCLIcommand("writef2file", __FILE__, write_flot_file_cli, "write float to file",
                       "<filename> <float variable>", "writef2file val.txt a",
