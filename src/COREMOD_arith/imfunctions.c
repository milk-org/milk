...
errno_t arith_image_function_im_im__d_d(const char *ID_name, const char *ID_out, double (*pt2function)(double))
{
    ...
    create_image_ID(ID_out, naxis, naxes, datatypeout, data.SHARED_DFT, data.NBKEYWORD_DFT, 0, &IDout);
    free(naxes);
...
errno_t arith_image_function_imd_im__dd_d(const char *ID_name, double v0, const char *ID_out,
...
errno_t arith_image_function_imdd_im__ddd_d(const char *ID_name, double v0, double v1, const char *ID_out,
...
errno_t arith_image_function_2_1(const char *ID_name1, const char *ID_name2, const char *ID_out,
                                 double (*pt2function)(double, double))
{
    imageID ID1;
    imageID ID2;
    ...
    if (op3D2Dto3D == 0)
        ...
        {
            PRINT_ERROR("images %s and %s have different number of elements ( %ld %ld )\n", ID_name1, ID_name2,
                        nelement1, nelement2);
            exit(0);
        }
...
#pragma omp for
                ...
                for (ii = 0; ii < nelement; ii++)
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    for (ii = 0; ii < xysize; ii++)
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.UI8[kk * xysize + ii]),
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                for (ii = 0; ii < nelement; ii++)
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.UI8[ii]), data.image[ID2].array.D[ii]);
                }
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    for (ii = 0; ii < xysize; ii++)
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.UI8[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.UI16[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.UI16[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.UI16[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.UI32[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.UI32[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.UI32[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.UI64[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.UI64[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.UI64[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.SI8[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.SI8[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.SI8[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.SI16[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.SI16[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.SI16[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.SI32[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.SI32[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.SI32[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.SI64[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.SI64[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.SI64[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] =
                            pt2function((double)(data.image[ID1].array.F[kk * xysize + ii]),
                                        (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), (double)(data.image[ID2].array.F[ii]));
                }
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    for (ii = 0; ii < xysize; ii++)
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.F[kk * xysize + ii]), (double)(data.image[ID2].array.F[ii]));
                    }
            }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function((double)(data.image[ID1].array.F[ii]), data.image[ID2].array.D[ii]);
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.D[kk * xysize + ii] = pt2function(
                            (double)(data.image[ID1].array.F[kk * xysize + ii]), data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.UI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.UI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.UI16[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.UI16[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.UI32[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.UI32[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.UI64[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.UI64[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.SI8[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.SI8[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.SI16[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.SI16[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.SI32[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.SI32[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.SI64[ii]));
                }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.F[ii] =
                        pt2function(data.image[ID1].array.D[ii], (double)(data.image[ID2].array.F[ii]));
                }
...
#pragma omp for
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    ...
                    {
                        data.image[IDout].array.F[kk * xysize + ii] = pt2function(
                            data.image[ID1].array.D[kk * xysize + ii], (double)(data.image[ID2].array.F[ii]));
                    }
        }
...
#pragma omp for
                ...
                {
                    data.image[IDout].array.D[ii] =
                        pt2function(data.image[ID1].array.D[ii], data.image[ID2].array.D[ii]);
                }
                ...
                for (kk = 0; kk < naxes[2]; kk++)
                    for (ii = 0; ii < xysize; ii++)
                    {
                        data.image[IDout].array.D[kk * xysize + ii] =
                            pt2function(data.image[ID1].array.D[kk * xysize + ii], data.image[ID2].array.D[ii]);
                    }
        }
    }
...
#pragma omp for
            ...
            for (ii = 0; ii < nelement; ii++)
            {
                data.image[ID1].array.CF[ii].re =
                    pt2function((double)(data.image[ID1].array.CF[ii].re), (double)(data.image[ID2].array.CF[ii].re));
                data.image[ID1].array.CF[ii].im =
                    pt2function((double)(data.image[ID1].array.CF[ii].im), (double)(data.image[ID2].array.CF[ii].im));
            }
        }
...
#pragma omp for
            ...
            for (ii = 0; ii < nelement; ii++)
            {
                data.image[ID1].array.CD[ii].re =
                    pt2function((double)(data.image[ID1].array.CD[ii].re), (double)(data.image[ID2].array.CD[ii].re));
                data.image[ID1].array.CD[ii].im =
                    pt2function((double)(data.image[ID1].array.CD[ii].im), (double)(data.image[ID2].array.CD[ii].im));
            }
        }
...
errno_t arith_image_function_2_1_inplace(const char *ID_name1, const char *ID_name2,
                                         double (*pt2function)(double, double))
{
    imageID ID1;
    imageID ID2;
...
errno_t arith_image_function_CF_CF__CF(const char *ID_name1, const char *ID_name2, const char *ID_out,
                                       complex_float (*pt2function)(complex_float, complex_float))
{
    ...
    create_image_ID(ID_out, naxis, naxes, datatype1, data.SHARED_DFT, data.NBKEYWORD_DFT, 0, &IDout);
    free(naxes);
...
errno_t arith_image_function_CD_CD__CD(const char *ID_name1, const char *ID_name2, const char *ID_out,
