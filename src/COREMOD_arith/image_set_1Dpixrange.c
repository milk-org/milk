...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".imname", "input image", "im1",
                               ...
                               { CLIARG_FLOAT32, ".pixval", "pixel value", "3.2",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &pixval, &fpi_pixval },
                               { CLIARG_UINT32, ".mini", "min index", "10", CLIARG_VISIBLE_DEFAULT,
                                 (void **) &minindex, &fpi_minindex },
                               { CLIARG_UINT32, ".maxi", "max index", "50", CLIARG_VISIBLE_DEFAULT,
                                 (void **) &maxindex, &fpi_maxindex } };

static CLICMDDATA CLIcmddata = { "setpix1Drange", "set image pixel value over range",
