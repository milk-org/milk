...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".inim", "input image", "im0", CLIARG_VISIBLE_DEFAULT,
                                 (void **) &inimname, NULL },
                               { CLIARG_STR, ".outim", "output image", "imout",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outimname, NULL },
                               { CLIARG_UINT32, ".axisA", "axis to merged", "2",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &axisA, &fpi_axisA },
                               { CLIARG_UINT32, ".axisB", "merge into this axis", "0",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &axisB, &fpi_axisB },
                               { CLIARG_UINT32, ".colsize", "column size", "10",
                                 CLIARG_HIDDEN_DEFAULT, (void **) &colsize, &fpi_colsize } };

static CLICMDDATA CLIcmddata = { "unfold", "image unfold, merge axis A into axis B",
...
errno_t image_unfold(IMGID inimg, IMGID *outimg, uint8_t axisA, uint8_t axisB, int colsize)
{
    DEBUG_TRACE_FSTART();
