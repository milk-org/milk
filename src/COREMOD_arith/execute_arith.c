    ...
    for (int i = (nbword - 1); i > -1; i--)
        {
            ...
            if ((passedequ == 0) &&
                ...
                {
                    PRINT_WARNING("%s is a non-existing variable or image",
                                  word[i]);
                    OKea = 0;
                }
        }
                    ...
                    if (word_type[i] == ARITHTOKENTYPE_NUMBER)
                        {
                            ...
                            create_variable_ID(name,
                                               1.0 * strtod(word[i], NULL));
                            strcpy(word[i], name);
                            word_type[i] = ARITHTOKENTYPE_VARIABLE;
                            tmp_name_index++;
                        }
             ...
             */
                    ...
                    for (int i = 0; i < nbword - 3; i++)
                        if ((word_type[i] == ARITHTOKENTYPE_OPENPAR) &&
                            ...
                            (strcmp(word[i + 1], "-") == 0))
                            {
                                data.variable[variable_ID(word[i + 2])]
                                    .value.f =
                                    -data.variable[variable_ID(word[i + 2])]
                                         .value.f;
              ...
              printf("\n");
            */
                    if (word_type[highest_priority_index] ==
                        ARITHTOKENTYPE_OPERAND)
                        {
                            ...
                            if (strcmp(word[highest_priority_index], "+") == 0)
                                {
                                    if ((word_type[highest_priority_index -
                                        ...
                                        (word_type[highest_priority_index +
                                                   1] ==
                                         ARITHTOKENTYPE_VARIABLE))
                                        {
                                            tmp_prec =
                            ...
                            for (j = highest_priority_index; j < nbword - 2;
                                 j++)
                                {
                                    strcpy(word[j], word[j + 2]);
                                    word_type[j] = word_type[j + 2];
                    ...
                    if (word_type[highest_priority_index] == 8)
                        {
                            ...
                            if (strcmp(word[highest_priority_index], "acos") ==
                                0)
                                {
                            ...
                            if (strcmp(word[highest_priority_index], "asin") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "atan") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "ceil") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "cos") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "cosh") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "exp") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "fabs") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "floor") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index],
                                       "imedian") == 0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        ARITHTOKENTYPE_IMAGE)
                            ...
                            if (strcmp(word[highest_priority_index], "itot") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        ARITHTOKENTYPE_IMAGE)
                                        {
                                            tmp_prec = arith_image_total(
                                                word[highest_priority_index +
                                                     1]);
                                            create_variable_ID(name, tmp_prec);
                                            tmp_name_index++;
                            ...
                            if (strcmp(word[highest_priority_index], "imean") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        ARITHTOKENTYPE_IMAGE)
                                        {
                                            tmp_prec = arith_image_mean(
                                                word[highest_priority_index +
                                                     1]);
                                            create_variable_ID(name, tmp_prec);
                                            tmp_name_index++;
                            ...
                            if (strcmp(word[highest_priority_index], "imin") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        ARITHTOKENTYPE_IMAGE)
                                        {
                                            tmp_prec = arith_image_min(
                                                word[highest_priority_index +
                                                     1]);
                                            create_variable_ID(name, tmp_prec);
                                            tmp_name_index++;
                            ...
                            if (strcmp(word[highest_priority_index], "imax") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        ARITHTOKENTYPE_IMAGE)
                                        {
                                            tmp_prec = arith_image_max(
                                                word[highest_priority_index +
                                                     1]);
                                            create_variable_ID(name, tmp_prec);
                                            tmp_name_index++;
                            ...
                            if (strcmp(word[highest_priority_index], "log") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "sqrt") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "sin") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "sinh") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "tan") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "tanh") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "posi") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "imdx") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            if (strcmp(word[highest_priority_index], "imdy") ==
                                0)
                                {
                                    if (word_type[highest_priority_index + 1] ==
                                        2)
                            ...
                            for (j = highest_priority_index + 1; j < nbword - 1;
                                 j++)
                                {
                    ...
                    if (word_type[highest_priority_index] == 11)
                        {
                            ...
                            if (strcmp(word[highest_priority_index], "fmod") ==
                                0)
                                {
                                    if ((word_type[highest_priority_index +
                                                   2] == 2) &&
                            ...
                            if (strcmp(word[highest_priority_index], "min") ==
                                0)
                                {
                                    if ((word_type[highest_priority_index +
                                                   2] == 2) &&
                            ...
                            if (strcmp(word[highest_priority_index], "max") ==
                                0)
                                {
                                    if ((word_type[highest_priority_index +
                                                   2] ==
                                    ...
                                    else if ((word_type[highest_priority_index +
                                                        2] ==
                                              ARITHTOKENTYPE_IMAGE) &&
                                             (word_type[highest_priority_index +
                                                        4] ==
                            ...
                            if (strcmp(word[highest_priority_index], "perc") ==
                                0)
                                {
                            ...
                            if (strcmp(word[highest_priority_index], "trunc") ==
                                0)
                                {
                                    if ((word_type[highest_priority_index +
                                                   2] ==
                            ...
                            if (word_type[2] == 2)
                                {
                                    create_variable_ID(
                                        word[0],
                                        data.variable[variable_ID(word[2])]
                                            .value.f);
                                    printf("%.20g\n",
                                           data.variable[variable_ID(word[2])]
                                               .value.f);
