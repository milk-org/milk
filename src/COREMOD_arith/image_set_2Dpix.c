...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".imname", "input image", "im1",
                               ...
                               { CLIARG_UINT32, ".col", "col index", "100", CLIARG_VISIBLE_DEFAULT,
                                 (void **) &colindex, &fpi_colindex },
                               { CLIARG_UINT32, ".row", "row index", "100", CLIARG_VISIBLE_DEFAULT,
                                 (void **) &rowindex, &fpi_rowindex } };
