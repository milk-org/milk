...
#define CROPWINDOWONOFF(wn)                                                          \
    { CLIARG_ONOFF,          ".w" #wn ".active",     "crop window active flag", "0", \
      CLIARG_HIDDEN_DEFAULT, (void **) &wactive[wn], &fpi_wactive[wn] }
...
#define CROPWINDOWXSTART(wn)                                                         \
    { CLIARG_UINT32,         ".w" #wn ".cropxstart",     "crop x coord start", "30", \
      CLIARG_HIDDEN_DEFAULT, (void **) &wcropxstart[wn], &fpi_wcropxstart[wn] }

#define CROPWINDOWXSIZE(wn)                                                        \
    { CLIARG_UINT32,         ".w" #wn ".cropxsize",     "crop x coord size", "30", \
      CLIARG_HIDDEN_DEFAULT, (void **) &wcropxsize[wn], &fpi_wcropxsize[wn] }

#define CROPWINDOWYSTART(wn)                                                         \
    { CLIARG_UINT32,         ".w" #wn ".cropystart",     "crop y coord start", "30", \
      CLIARG_HIDDEN_DEFAULT, (void **) &wcropystart[wn], &fpi_wcropystart[wn] }

#define CROPWINDOWYSIZE(wn)                                                        \
    { CLIARG_UINT32,         ".w" #wn ".cropysize",     "crop y coord size", "30", \
      CLIARG_HIDDEN_DEFAULT, (void **) &wcropysize[wn], &fpi_wcropysize[wn] }
...
#define CROPWINDOWBINFACT(wn)                                                \
    { CLIARG_UINT32,         ".w" #wn ".cropbinfact", "binning factor", "1", \
      CLIARG_HIDDEN_DEFAULT, (void **) &wbinfact[wn], &fpi_wbinfact[wn] }

#define CROPWPARAMS(wn)                                                                    \
    CROPWINDOWONOFF(wn), CROPWINDOWADDMODE(wn), CROPWINDOWXSTART(wn), CROPWINDOWXSIZE(wn), \
        CROPWINDOWYSTART(wn), CROPWINDOWYSIZE(wn), CROPWINDOWXPOS(wn), CROPWINDOWYPOS(wn), \
        CROPWINDOWBINFACT(wn)

static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".insname", "input stream name", "inim",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &mcropinsname,
                                 &fpi_mcropinsname },
                               { CLIARG_STR, ".outsname", "output stream name", "outim",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outsname, &fpi_outsname },
                               { CLIARG_UINT32, ".outxsize", "output x size", "200",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outxsize, &fpi_outxsize },
                               { CLIARG_UINT32, ".outysize", "output y size", "200",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outysize, &fpi_outysize },
                               CROPWPARAMS(00),
                               CROPWPARAMS(01),
                               CROPWPARAMS(02),
                               CROPWPARAMS(03),
...
static CLICMDDATA CLIcmddata = { "multicrop2D", "crop 2D image, multiple crops",
...
static errno_t compute_function()
{
    ...
    INSERT_STD_PROCINFO_COMPUTEFUNC_LOOPSTART
    {
            ...
            if (*wactive[cropwindow] == 1)
            {
                ...
                for (uint32_t jj = 0; jj < jjmax; jj++)
                {
                    ...
                    if (*waddmode[cropwindow] == 0)
                    {
                        ...
                        {
                        case _DATATYPE_FLOAT:
                            memcpy(&tmparrayf[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                              *wcropxpos[cropwindow]],
                                   &imgin.im->array.F[indjj + (*wcropxstart[cropwindow])],
                                   iimax * SIZEOF_DATATYPE_FLOAT);
                            break;

                        case _DATATYPE_DOUBLE:
                            memcpy(&tmparrayd[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                              *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_UINT8:
                            memcpy(&tmparrayui8[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_UINT16:
                            memcpy(&tmparrayui16[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                 *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_UINT32:
                            memcpy(&tmparrayui32[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                 *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_UINT64:
                            memcpy(&tmparrayui64[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                 *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_INT8:
                            memcpy(&tmparraysi8[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_INT16:
                            memcpy(&tmparraysi16[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                 *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_INT32:
                            memcpy(&tmparraysi32[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                 *wcropxpos[cropwindow]],
                        ...
                        case _DATATYPE_INT64:
                            memcpy(&tmparraysi64[(*wcropypos[cropwindow] + jj) * (*outxsize) +
                                                 *wcropxpos[cropwindow]],
                    ...
                    else // add pixels
                    {
                        ...
                        case _DATATYPE_FLOAT:
                            ...
                            {
                                tmparrayf[(*wcropypos[cropwindow] + jj / (*wbinfact[cropwindow])) *
                                              (*outxsize) +
                                          (*wcropxpos[cropwindow] +
                                           ii / (*wbinfact[cropwindow]))] +=
                        ...
                        case _DATATYPE_DOUBLE:
                            for (int ii = 0; ii < iimax; ii++)
                            {
                                tmparrayd[(*wcropypos[cropwindow] + jj / (*wbinfact[cropwindow])) *
                                              (*outxsize) +
                                          (*wcropxpos[cropwindow] +
                                           ii / (*wbinfact[cropwindow]))] +=
                        ...
                        case _DATATYPE_UINT8:
                            ...
                            {
                                tmparrayui8
                                    [(*wcropypos[cropwindow] + jj / (*wbinfact[cropwindow])) *
                                         (*outxsize) +
                                     (*wcropxpos[cropwindow] + ii / (*wbinfact[cropwindow]))] +=
        ...
        case _DATATYPE_UINT16:
            memcpy(imgout.im->array.UI16, tmparrayui16,
                   sizeof(uint16_t) * (*outxsize) * (*outysize));
            break;

        case _DATATYPE_UINT32:
            memcpy(imgout.im->array.UI32, tmparrayui32,
                   sizeof(uint32_t) * (*outxsize) * (*outysize));
            break;

        case _DATATYPE_UINT64:
            memcpy(imgout.im->array.UI64, tmparrayui64,
                   sizeof(uint64_t) * (*outxsize) * (*outysize));
            break;
        ...
        case _DATATYPE_INT16:
            memcpy(imgout.im->array.SI16, tmparraysi16,
                   sizeof(int16_t) * (*outxsize) * (*outysize));
            break;

        case _DATATYPE_INT32:
            memcpy(imgout.im->array.SI32, tmparraysi32,
                   sizeof(int32_t) * (*outxsize) * (*outysize));
            break;

        case _DATATYPE_INT64:
            memcpy(imgout.im->array.SI64, tmparraysi64,
                   sizeof(int64_t) * (*outxsize) * (*outysize));
            break;
        }
