...
static CLICMDDATA CLIcmddata = { "pixunmap", "pixel unmapping of image to 1D",
...
static errno_t compute_function()
{
    ...
    {
        int64_t pixindex = imgmap.im->array.SI32[ii];
        if ((pixindex > -1) && (pixindex < x1Dsize))
        {
    ...
    INSERT_STD_PROCINFO_COMPUTEFUNC_LOOPSTART
    {
        ...
        case _DATATYPE_INT8:
            for (uint64_t pixi = 0; pixi < nbpix; pixi++)
            {
                imgout.im->array.F[map_1Dpixindex[pixi]] +=
                    imgin.im->array.SI8[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.F[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_UINT8:
            ...
            {
                imgout.im->array.F[map_1Dpixindex[pixi]] +=
                    imgin.im->array.UI8[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.F[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_INT16:
            ...
            {
                imgout.im->array.F[map_1Dpixindex[pixi]] +=
                    imgin.im->array.SI16[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.F[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_UINT16:
            ...
            {
                imgout.im->array.F[map_1Dpixindex[pixi]] +=
                    imgin.im->array.UI16[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.F[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_INT32:
            ...
            {
                imgout.im->array.F[map_1Dpixindex[pixi]] +=
                    imgin.im->array.SI32[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.F[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_UINT32:
            ...
            {
                imgout.im->array.F[map_1Dpixindex[pixi]] +=
                    imgin.im->array.UI32[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.F[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_INT64:
            for (uint64_t pixi = 0; pixi < nbpix; pixi++)
            {
                imgout.im->array.D[map_1Dpixindex[pixi]] +=
                    imgin.im->array.SI64[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.D[ii] /= map_pixcnt[ii];
        ...
        case _DATATYPE_UINT64:
            ...
            {
                imgout.im->array.D[map_1Dpixindex[pixi]] +=
                    imgin.im->array.UI64[map_2Dpixindex[pixi]];
            }
            for (uint32_t ii = 0; ii < x1Dsize; ii++)
            {
                imgout.im->array.D[ii] /= map_pixcnt[ii];
