...
{
    if (0 + CLI_checkarg(1, CLIARG_IMG) + CLI_checkarg(2, CLIARG_IMG) + CLI_checkarg(3, CLIARG_STR_NOT_IMG) == 0)
    {
        arith_image_merge3D(data.cmdargtoken[1].val.string, data.cmdargtoken[2].val.string,
...
errno_t image_merge3D_addCLIcmd()
{
    ...
    RegisterCLIcommand("merge3d", __FILE__, arith_image_merge3D_cli, "merge two 3D cubes into one",
                       "<input cube 1> <input cube 2> <output cube>", "merge3d imc1 imc2 imcout",
...
imageID arith_image_merge3D(const char *ID_name1, const char *ID_name2, const char *IDout_name)
{
    ...
    FUNC_CHECK_RETURN(create_image_ID(IDout_name, 3, sizearray, datatype, 0, 0, 0, &IDout));
    ...
    case _DATATYPE_DOUBLE:
        ...
        memcpy(mapv, (void *)data.image[ID1].array.D, sizeof(double) * xsize * ysize * zsize1);
    ...
    case _DATATYPE_INT16:
        ...
        memcpy(mapv, (void *)data.image[ID1].array.SI16, sizeof(int16_t) * xsize * ysize * zsize1);
    ...
    case _DATATYPE_UINT16:
        ...
        memcpy(mapv, (void *)data.image[ID1].array.UI16, sizeof(uint16_t) * xsize * ysize * zsize1);
