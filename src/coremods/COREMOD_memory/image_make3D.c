...
static FPS_APP_INFO FPS_app_info = {
    ...
    .description_long = "Create a new 3D image cube in shared memory with specified dimensions and "
                        "data type. Initializes all pixel values to zero."
};
...
#define FPS_PARAMS(X)                                                                 \
    ...
    X(".zsize", &imzsize, FPTYPE_UINT32, 1, FPFLAG_DEFAULT_INPUT, "z size")
