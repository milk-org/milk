...
static void print_help(const char *progname, int color)
{
    ...
    printf("  %s%s%s %s[-p prefix]%s %s<streamname>%s\n\n", color ? MH_CMD : "", progname,
           color ? MH_RST : "", color ? MH_OPT : "", color ? MH_RST : "", color ? MH_ARG : "",
           color ? MH_RST : "");
    milk_help_section("Description", color);
    printf("  %s\n\n", LSL_DESC_LONG);
    milk_help_section("Options", color);
    printf("  %s%-25s%s %s\n", color ? MH_OPT : "", "-p <prefix>", color ? MH_RST : "",
           "Prefix for the link name (default: none)");
    printf("  %s%-25s%s %s\n", color ? MH_OPT : "", "-h, --help", color ? MH_RST : "",
           "Show this help and exit");
    printf("  %s%-25s%s %s\n\n", color ? MH_OPT : "", "-h1, --help-oneline", color ? MH_RST : "",
    ...
    printf("  %s$ milk-stream-link%s %s-p myprefix- ircam0%s\n\n", color ? MH_CMD : "",
           color ? MH_RST : "", color ? MH_ARG : "", color ? MH_RST : "");
 ...
 */
static void write_imsize(const char *shmdir, const char *srcname, const char *linkname)
{
