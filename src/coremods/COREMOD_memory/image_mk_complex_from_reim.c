...
static FPS_APP_INFO FPS_app_info = {
    ...
    .description_long = "Construct a complex image from separate real and imaginary component "
                        "images. Combines two real-valued streams into one complex stream."
};
...
#define FPS_PARAMS(X)                                                                          \
    X(".imre_name", inreimname, FPTYPE_STREAMNAME, 1, FPFLAG_DEFAULT_INPUT, "real image")      \
    X(".imim_name", inimimname, FPTYPE_STREAMNAME, 1, FPFLAG_DEFAULT_INPUT, "imaginary image") \
