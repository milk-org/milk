...
#define DEFINE_IMGID_OPT(op, tag)                                           \
    ...
    {                                                                       \
        return arith_image_cst##op##_optimized_IMGID(imgin, f1, imgout);    \
    }
...
#define DEFINE_IMGID_FPTR(op, fptr)                                         \
    int arith_image_cst##op##_IMGID(IMGID *imgin, double f1, IMGID *imgout) \
    {                                                                       \
        return arith_image_function_1f_1_IMGID(imgin, f1, imgout, &fptr);   \
    }
    ...
    {                                                                           \
        ...
        {                                                                       \
            ...
            imgout.mdt->NBkw   = NB_KEYWNODE_MAX;                               \
                                                                                ...
                                                                                \
        int ret = arith_image_cst##op##_IMGID(&imgin, f1, &imgout);             \
                                                                                \
...
#define DEFINE_CST_INPLACE(op, fptr)                                  \
    ...
    {                                                                 \
        arith_image_function_1f_1_inplace(ID_name, f1, &fptr);        \
        return 0;                                                     \
    }
