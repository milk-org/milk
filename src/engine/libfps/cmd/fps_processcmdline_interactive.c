...
static void fps_cmd_handle_sys(const char           *FPScommand,
                               int                   nbword,
                               const char           *FPSarg0,
                               const char           *FPSarg1,
 ...
 */
static void fps_cmd_handle_tmux(const char *FPScommand,
                                int         nbword,
                                FPS        *fps,
                                int         fpsindex,
                                int        *cmdFOUND,
 ...
 */
static void fps_cmd_handle_conf(const char *FPScommand,
                                int         nbword,
                                FPS        *fps,
                                int         fpsindex,
                                int        *cmdFOUND,
 ...
 * lifecycle functions.
 */
static void fps_cmd_handle_run(const char *FPScommand,
                               int         nbword,
                               FPS        *fps,
                               int         fpsindex,
                               int        *cmdFOUND,
                                         ...
                                         uint64_t             *taskstatus)
{
    ...
    *taskstatus |= FPSTASK_STATUS_RECEIVED;
    ...
    fps_cmd_handle_sys(FPScommand, nbword, FPSarg0, FPSarg1, fpsCTRLvar, fps, keywnode,
                       fpsctrlqueuelist, &cmdFOUND, &cmdOK, taskstatus, &testcnt);
