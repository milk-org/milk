/**
 * @file fpsCTRL_TUIcompat.h
 * @brief Drop-in replacement for TUItools.h for standalone fpsCTRL build
 *
 ...
 *
 * Include this INSTEAD of TUItools.h when building milk-fpsCTRL standalone.
...
#ifndef _FPSCTRL_TUITOOLS_COMPAT_H
#define _FPSCTRL_TUITOOLS_COMPAT_H
...
{
    /* Clear to end of screen from current cursor position to remove ghost lines */
    SC_APPEND("\033[J");
...
#endif /* _FPSCTRL_TUITOOLS_COMPAT_H */
