...
#define FSET_DESC "set a parameter value in a Function Parameter Structure (FPS)"
...
int main(int argc, char *argv[])
{
...

    {
        ...
        {
            vOK = 0;
            PRINT_ERROR("Error: Failed to set parameter '%s'. Type mismatch or invalid format.",
                        fullkey);
