...
static inline void TUI_printfw(const char *fmt, ...)
{
    ...
    available = sc_term_cols - sc_cursor_col;
    if(available <= 0)
    {
        return; /* Skip drawing if past right edge */
    }

    buf_space = SC_FRAMEBUF_SIZE - sc_framebuf_pos;
    print_limit = (size_t)available + 1; /* +1 for null terminator */
    if(print_limit > buf_space)
    {
        print_limit = buf_space;
    }

    va_start(ap, fmt);
    n = vsnprintf(sc_framebuf + sc_framebuf_pos, print_limit, fmt, ap);
    va_end(ap);

    if(n > 0)
    {
        int written = (n < available) ? n : available;
        if(written > (int)(buf_space - 1))
        {
            written = (int)(buf_space - 1);
        }
        
        sc_framebuf_pos += written;
        sc_cursor_col += written;
    }
}
...
static inline void screenprint_setcolor(int idx)
{
    ...
    if (ansi__color_level >= 3)
    {
        switch(idx)
        {
        case 1:  SC_APPEND("\033[30;47m");             break; /* black on white */
        ...
        case 6:  SC_APPEND("\033[38;2;80;220;80m");    break; /* green        */
        case 7:  SC_APPEND("\033[38;2;0;200;220m");    break; /* cyan         */
        case 8:  SC_APPEND("\033[38;2;240;60;60m");    break; /* red          */
    ...
    else if (ansi__color_level == 2)
    {
        ...
        case 6:  SC_APPEND("\033[38;5;114m"); break; /* green        */
        case 7:  SC_APPEND("\033[38;5;44m");  break; /* cyan         */
        case 8:  SC_APPEND("\033[38;5;203m"); break; /* red          */
    ...
    else
    {
        ...
        case 6:  SC_APPEND("\033[32m"); break; /* green        */
        case 7:  SC_APPEND("\033[36m"); break; /* cyan         */
        case 8:  SC_APPEND("\033[31m"); break; /* red          */
