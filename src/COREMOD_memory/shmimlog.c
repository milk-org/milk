            ...
            if (logshimconf[0].on == 0)
                {
                    ...
                    tdel.tv_sec = 0;
                    tdel.tv_nsec =
                        (long) (1000.0 * tdelay_us); // * rand() / RAND_MAX);
                            ...
                            if (data.image[ID].md->CBsize > 0)
                                {
                                    ...
                                    if (grabStart < 0)
                                        {
                                            ...
                                            grabEnd0 =
                                                data.image[ID].md->CBsize - 1;
                                            grabSpan0 =
                                                grabEnd0 - grabStart0 + 1;

                                            grabStart1 = 0;
                                            grabEnd1   = grabEnd;
                                            grabSpan1 =
                                                grabEnd1 - grabStart1 + 1;
                                        }
                                    else
                                        {
                                    ...
                                    if (NBframesbehind > 1)
                                        {
                                            SkipWait =
                                                1; // don't wait, proceed to grab next frame
                                        }
                                    else
                                        {
                                            SkipWait = 0;
            ...
            if ((index > zsize - 1) || ((timeout == 1) && (index > 0)))
                {
                    ...
                    if (tOK == 1)
                        {
                            if (pthread_tryjoin_np(thread_savefits, NULL) ==
                                EBUSY)
                                {
                                    VERBOSE = 1;
                                    if (VERBOSE > 0)
