...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".in_name", "input image", "im1",
                               ...
                               { CLIARG_STR, ".kwname", "keyword name", "KW1",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &kwname, NULL },
                               { CLIARG_STR, ".kwval", "keyword value", "blue",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &kwval, NULL },
                               { CLIARG_STR, ".comment", "comment", "keyword comment",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &comment, NULL } };

static CLICMDDATA CLIcmddata = { "imkwaddS", "add string type image keyword", CLICMD_FIELDS_NOFPS };
