...
errno_t shmim_setowner_addCLIcmd()
{
    ...
    RegisterCLIcommand("shmimsetowncreator", __FILE__, shmim_setowner_creator__cli, "set owner to creator PID",
                       "<sname>", "shmimsetowncreator im3", "imageID shmim_setowner_creator(const char *name)");

    RegisterCLIcommand("shmimsetowncurrent", __FILE__, shmim_setowner_current__cli, "set owner to current PID",
                       "<sname>", "shmimsetowncurrent im3", "imageID shmim_setowner_current(const char *name)");

    RegisterCLIcommand("shmimsetowninit", __FILE__, shmim_setowner_init__cli, "set owner to init PID", "<sname>",
                       "shmimsetowninit im3", "imageID shmim_setowner_init(const char *name)");
