                    ...
                    for (ii = 0; ii < nbpixslice[slice]; ii++)
                        {
                            ...
                            data.image[IDout_pixslice].array.UI16
            ...
            if (data.image[IDin].md[0].sem == 0)
            ...
            else
                {
                    ...
                    if (processinfo->loopcnt == 0)
                        {
                            sem_getvalue(
                                data.image[IDin].semptr[in_semwaitindex],
                                &semval);
                            for (scnt = 0; scnt < semval; scnt++)
                                {
                                    sem_trywait(data.image[IDin]
                                                    .semptr[in_semwaitindex]);
                                }
                        }
                }
