...
{
    RegisterCLIcommand("streamburst", __FILE__, COREMOD_MEMORY_image_streamburst__cli,
    ...
    RegisterCLIcommand("creaimstream", __FILE__, COREMOD_MEMORY_image_streamupdateloop__cli,
    ...
    RegisterCLIcommand("creaimstreamstrig", __FILE__,
                                              ...
                                              __attribute__((unused)) int timingmode)
{
    ...
    while (loopOK == 1)
    {
        ...
        framesize = data.image[IDin[cubeindex]].md[0].size[0] *
                    data.image[IDin[cubeindex]].md[0].size[1] * ImageStreamIO_typesize(datatype);
