...
// When the number of free images in the data structure is below
// NB_IMAGES_BUFFER, it is increased by  NB_IMAGES_BUFFER
...
// When the number of free variables in the data structure is below
// NB_VARIABLES_BUFFER, it is increased by  NB_VARIABLES_BUFFER
