...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".in_name", "input image", "im1",
                               ...
                               { CLIARG_STR, ".outave_name", "output average image", "out1",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outimave, NULL },
                               { CLIARG_UINT32, ".out_shared", "output shared flag", "1",
                                 CLIARG_HIDDEN_DEFAULT, (void **) &outimshared, NULL },
                               { CLIARG_STR, ".outrms_name", "output RMS image", "out1",
                                 CLIARG_HIDDEN_DEFAULT, (void **) &outimrms, NULL },
                               { CLIARG_UINT64, ".NBcoadd", "number of coadded frames", "100",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &NBcoadd, NULL },
                               { CLIARG_UINT64, ".cntindex", "counter index", "5",
                                 CLIARG_HIDDEN_DEFAULT, (void **) &cntindex, &fpi_cntindex },
                               { CLIARG_ONOFF, ".comp.ave", "compute average", "1",
                                 CLIARG_HIDDEN_DEFAULT, (void **) &compave, &fpi_compave },
                               { CLIARG_ONOFF, ".comp.rms", "compute rms", "0",
                                 CLIARG_HIDDEN_DEFAULT, (void **) &comprms, &fpi_comprms } };
    ...
    *cntindex = 0;
    ...
    if ((*cntindex) >= (*NBcoadd))
    {
        ...
        if (*comprms == 1)
        {
            ...
            for (uint_fast64_t pixi = 0; pixi < xysize; pixi++)
            {
                outimgrms.im->array.F[pixi] = sqrt(imdataarrayPOW[pixi]) / (*cntindex);
            }
