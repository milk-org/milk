...
static CLICMDARGDEF farg[] = {
    {CLIARG_IMG, ".imre_name", "real image", "imre", CLIARG_VISIBLE_DEFAULT, (void **)&inreimname, NULL},
    {CLIARG_IMG, ".imim_name", "imaginary image", "imim", CLIARG_VISIBLE_DEFAULT, (void **)&inimimname, NULL},
