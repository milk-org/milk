...
static CLICMDARGDEF farg[] = {
    ...
    { CLIARG_INT32, ".n_input", "number of inputs to concatenate", "n_input",
      CLIARG_VISIBLE_DEFAULT, (void **) &ptr_n_input, NULL }
};

static CLICMDDATA CLIcmddata = { "shmimmerge", "Merge N in stream into out stream",
...
static errno_t compute_function()
{
    ...
    {
        offset_bytes[kk] = acc;
        size_bytes[kk]   = img_in_arr[kk].size[0] * ImageStreamIO_typesize(img_in_arr[kk].datatype);
