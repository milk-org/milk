                ...
                case _DATATYPE_UINT8:
                    for (uint32_t ii = 0; ii < xsize; ii++)
                        for (uint32_t jj = 0; jj < ysize; jj++)
                            {
                                data.image[IDout]
                                    .array.UI8[jj * 2 * xsize + ii + Xoffset] =
                ...
                case _DATATYPE_INT8:
                    for (uint32_t ii = 0; ii < xsize; ii++)
                        for (uint32_t jj = 0; jj < ysize; jj++)
                            {
                                data.image[IDout]
                                    .array.SI8[jj * 2 * xsize + ii + Xoffset] =
                ...
                case _DATATYPE_COMPLEX_FLOAT:
                    for (uint32_t ii = 0; ii < xsize; ii++)
                        for (uint32_t jj = 0; jj < ysize; jj++)
                            {
                                data.image[IDout]
                                    .array.CF[jj * 2 * xsize + ii + Xoffset] =
                ...
                case _DATATYPE_COMPLEX_DOUBLE:
                    for (uint32_t ii = 0; ii < xsize; ii++)
                        for (uint32_t jj = 0; jj < ysize; jj++)
                            {
                                data.image[IDout]
                                    .array.CD[jj * 2 * xsize + ii + Xoffset] =
