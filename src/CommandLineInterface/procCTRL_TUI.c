    ...
    if (exists == -1)
        {
            ...
            umask(0);
            SM_fd =
                open(SM_fname, O_RDWR | O_CREAT | O_TRUNC, (mode_t) FILEMODE);
            if (SM_fd == -1)
                {
            ...
            pinfolist = (PROCESSINFOLIST *) mmap(0,
                                                 sharedsize,
    ...
    else
        {
            ...
            pinfolist =
                (PROCESSINFOLIST *) processinfo_shm_link(SM_fname, &SM_fd);
            ...
            if (processinfo != NULL)
                {
                    ...
                    if (IDin > -1)
                        {
                            int sptisize =
                                data.image[IDin].md[0].NBproctrace - 1;
                    ...
                    data.image[outstreamID].streamproctrace[0].procwrite_PID =
                        getpid();
                    ...
                    data.image[outstreamID].streamproctrace[0].ts_streamupdate =
                        ts;
            ...
            if (processinfo->dtiter_limit_enable != 0)
                {
                    ...
                    dtiter = processinfo->texecstart[processinfo->timerindex]
                                 .tv_nsec -
            ...
            if (processinfo->dtexec_limit_enable != 0)
                {
                    ...
                    dtexec =
                        processinfo->texecend[processinfo->timerindex].tv_nsec -
                        processinfo->texecstart[processinfo->timerindex]
                            .tv_nsec;
                    dtexec +=
                        1000000000 *
            ...
            for (cpu = 0; cpu < pinfop->NBcpus; cpu++)
                {
                    ...
                    if (fpout == NULL)
                        ...
                        {
                            if (fgets(outstring, STRINGMAXLEN_DEFAULT, fpout) ==
                                NULL)
                                {
                                    printf("WARNING: fgets error\n");
                                }
                    ...
                    if (sscanf(line, "%31[^:]: %s", string0, string1) == 2)
                        {
                            if (spindex == 0)
                                {
                                    if (strcmp(string0, "Cpus_allowed_list") ==
                                        0)
                                        {
                                            strcpy(pinfodisp->cpusallowed,
                                                   string1);
                                        }
                            ...
                            if (strcmp(string0, "VmRSS") == 0)
                                {
                                    pinfodisp->VmRSSarray[spindex] =
                                        atol(string1);
                                }

                            if (strcmp(string0, "nonvoluntary_ctxt_switches") ==
                                0)
                                {
                                    pinfodisp->ctxtsw_nonvoluntary[spindex] =
                                        atoi(string1);
                                }
                            if (strcmp(string0, "voluntary_ctxt_switches") == 0)
                                {
                                    pinfodisp->ctxtsw_voluntary[spindex] =
                                        atoi(string1);
                                }
                        }
                }
          ...
          */
            ...
            if (pinfop->NBpindexActive > 0)
                {
                    ...
                    double *timearray;
                    long   *indexarray;
                    timearray = (double *) malloc(sizeof(double) *
                                                  pinfop->NBpindexActive);
                    if (timearray == NULL)
                        {
                            PRINT_ERROR("malloc returns NULL pointer");
                    ...
                    indexarray =
                        (long *) malloc(sizeof(long) * pinfop->NBpindexActive);
                    if (indexarray == NULL)
                        {
                            PRINT_ERROR("malloc returns NULL pointer");
                            abort();
                            ...
                            if (pinfop->pinfommapped[pindex] == 1)
                                {
                                    ...
                                    timearray[index] =
                                        -1.0 * pinfop->pinfoarray[pindex]
                                                   ->createtime.tv_sec -
                                        1.0e-9 * pinfop->pinfoarray[pindex]
                                                     ->createtime.tv_nsec;
                                    listcnt++;
                                }
                        }
                    ...
                    for (index = 0; index < pinfop->NBpindexActive; index++)
                        {
                            pinfop->sorted_pindex_time[index] =
                                indexarray[index];
                        }
            ...
            if (pinfop->DisplayMode ==
                PROCCTRL_DISPLAYMODE_RESOURCES) // only compute of displayed processes
                {
                    ...
                    for (pindexdisp = 0; pindexdisp < pinfop->NBpinfodisp;
                         pindexdisp++)
                        {
                            if (pinfop->loop == 1)
                                {
                                    ...
                                    if (pinfolist->active[pindexdisp] != 0)
                                        {
                                            ...
                                            if (pinfop->pinfodisp[pindexdisp]
                                                ...
                                                0) // pinfop->pinfodisp[pindex].NBsubprocesses should never be zero - should be at least 1 (for main process)
                                                {
                                                    ...
                                                    pinfop->scandebugline =
                                                        __LINE__;

                                                    pinfop->psysinfostatus
                                                        [pindex] =
    ...
    while (loopOK == 1)
        {
            ...
            switch (ch)
                ...
                case 'u': // undelect all
                    for (index = 0; index < procinfoproc.NBpindexActive;
                         index++)
                        {
                ...
                case KEY_UP:
                    ...
                    if (TimeSorted == 0)
                    ...
                    else
                        {
                            pindexSelected =
                                procinfoproc
                                    .sorted_pindex_time[pindexActiveSelected];
                        }
                    break;
                    ...
                    if ((selectedOK == 0) && (pindexSelectedOK == 1))
                        {
                            ...
                            if (pinfolist->active[pindex] != 1)
                                {
                                    remove(procinfoproc.pinfoarray[pindex]
                                               ->logfilename);
                    ...
                    if ((selectedOK == 0) && (pindexSelectedOK == 1))
                        {
                            ...
                            if (procinfoproc.pinfoarray[pindex]->CTRLval == 0)
                                {
                                    procinfoproc.pinfoarray[pindex]->CTRLval =
                                        1;
                                }
                            else
                                {
                    ...
                    if (pinfolist->active[pindex] == 1)
                        {
                            ...
                            listindex = processinfo_SelectFromList(CPUsetList,
                                                                   NBCPUset);
                    ...
                    if (pinfolist->active[pindex] == 1)
                        {
                            ...
                            EXECUTE_SYSTEM_COMMAND(
                                "sudo cset proc -m %d root &> /dev/null",
                                pinfolist->PIDarray[pindex]);
                            EXECUTE_SYSTEM_COMMAND(
                ...
                case 'L': // toggle time limit (iter)
                    ...
                    if (ToggleValue == 0)
                    ...
                    else
                        {
                            ...
                            procinfoproc.pinfoarray[pindex]
                                ->dtiter_limit_enable = ToggleValue;
                        }
                    break;
                    ;
                ...
                case 'M': // toggle time limit (exec)
                    ...
                    if (ToggleValue == 0)
                    ...
                    else
                        {
                            ...
                            procinfoproc.pinfoarray[pindex]
                                ->dtexec_limit_enable = ToggleValue;
                        }
                    break;
                    ;
                    ...
                    if (procinfoproc.DisplayMode == PROCCTRL_DISPLAYMODE_HELP)
                        {
                            ...
                            attroff(attrval);
                            TUI_printfw(
                                "    Enable iteration/execution time limit");
                            TUI_newline();
                    ...
                    else
                        {
                            ...
                            if ((pindexSelected >= 0) &&
                                ...
                                {
                                    if (procinfoproc
                                            .pinfommapped[pindexSelected] == 1)
                                        {

                                            strcpy(
                                                pselected_FILE,
                                                procinfoproc
                                                    .pinfoarray[pindexSelected]
                                                    ->source_FILE);
                                            strcpy(
                                                pselected_FUNCTION,
                                                procinfoproc
                 ...
                 */
                            ...
                            if (procinfoproc.DisplayMode ==
                                PROCCTRL_DISPLAYMODE_RESOURCES)
                                {
                                    ...
                                    for (cpusocket = 0;
                                         cpusocket < procinfoproc.NBcpusocket;
                                         cpusocket++)
                                        {
                                            if (cpusocket > 0)
                                                {
                            ...
                            for (dispindex = 0; dispindex < dispindexMax;
                                 dispindex++)
                                {
                                    if (TimeSorted == 0)
                                        {
                                        ...
                                        {
                                            pindex =
                                                procinfoproc.sorted_pindex_time
                                                    [dispindex];
                                        }
                                                            ...
                                                            sprintf(
                                                                ...
                                                                procinfoproc
                                                                        .pinfoarray
                                                                            [pindex]
                                                                        ->loopcnt -
                                                                    procinfoproc.loopcntoffsetarray
                                                                        [pindex]);
                                                            ...
                                                            if (procinfoproc
                                                            ...
                                                            else
                                                                {
                                                                    ...
                                                                    if (procinfoproc
                                                                        ...
                                                                        {
                                                                            TUI_printfw(
                                                                                "  ERROR: procinfoproc.pinfodisp[pindex].NBsubprocesses = %d",
                                                                                (int) procinfoproc
                                                                                    .pinfodisp
                                                                                        [pindex]
                                                                                    .NBsubprocesses);
