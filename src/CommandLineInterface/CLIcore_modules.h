...
errno_t RegisterModule(CONST_WORD FileName, CONST_WORD PackageName, CONST_WORD InfoString, int versionmajor,
                       int versionminor, int versionpatch);

uint32_t RegisterCLIcommand(CONST_WORD CLIkey, CONST_WORD CLImodulesrc, errno_t (*CLIfptr)(), CONST_WORD CLIinfo,
                            CONST_WORD CLIsyntax, CONST_WORD CLIexample, CONST_WORD CLICcall);
