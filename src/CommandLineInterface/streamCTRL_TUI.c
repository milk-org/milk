                            ...
                            if (scanentryOK == 1)
                                {
                                    ...
                                    strncpy(streaminfo[sindex].sname,
                                            ...
                                            strlencp1);
                                    streaminfo[sindex]
                                        .sname[strlen(dir->d_name) -
                                               strlen(".im.shm")] = '\0';

                                    if (filter == 1)
                                        {
                                            if (strstr(streaminfo[sindex].sname,
                                                       namefilter) != NULL)
                                                {
                                                    sindex++;
                                                }
            ...
            if (streaminfoproc->fuserUpdate == 1)
                {
                    ...
                    if (streaminfoproc->sindexscan > NBsindex - 1)
                    ...
                    else
                        {
                            ...
                            if (PReadMode == 0)
                                {
                                    ...
                                    if (fp == NULL)
                                        {
                                            streaminfo[sindexscan1]
                                                .streamOpenPID_status =
                                                2; // failed
                                        }
                                    else
                                        {
                                            streaminfo[sindexscan1]
                                                .streamOpenPID_status = 1;

                                            if (fgets(plistoutline,
                                                      STRINGMAXLEN_LINE - 1,
                                                      fp) == NULL)
                                                {
                            ...
                            if (streaminfo[sindexscan1].streamOpenPID_status !=
                                2)
                                {
                                    char *pch;
                                    ...
                                    streaminfo[sindexscan1]
                                        .streamOpenPID_status = 1; // success
                                }
                            ...
                            for (pidIndex = 0;
                                 pidIndex <
                                 streaminfo[sindexscan1].streamOpenPID_cnt;
                                 pidIndex++)
                                {
                                    pid_t pid = streaminfo[sindexscan1]
                                                    .streamOpenPID[pidIndex];
                                    if ((getpgid(pid) >= 0) &&
                                        (pid != getpid()))
                                        {
                                            char *pname =
            ...
            switch (ch)
                ...
                case 'R': // remove stream
                    ...
                    ImageStreamIO_destroyIm(
                        &streamCTRLimages[streaminfo[sindex].ID]);
                ...
                case '{': // slower scan update
                    streaminfoproc.twaitus =
                        (int) (1.2 * streaminfoproc.twaitus);
            ...
            else
                {
                    ...
                    if (SORTING == 1) // alphabetical sorting
                        {
                            ...
                            for (sindex0 = 0; sindex0 < NBsindex - 1; sindex0++)
                                {
                                    for (sindex1 = sindex0 + 1;
                                         sindex1 < NBsindex;
                                         sindex1++)
                                        {
                                            if (strcmp(
                                                    streaminfo[larray[sindex0]]
                                                        .sname,
                                                    streaminfo[larray[sindex1]]
                                                        .sname) > 0)
                                                {
                                                    int tmpindex =
                                                        larray[sindex0];
                    ...
                    if ((SORTING == 2) ||
                        (SORTING == 3)) // recent update and process access
                        {
                            ...
                            larray = (long *) malloc(sizeof(long) * NBsindex);
                            varray =
                                (double *) malloc(sizeof(double) * NBsindex);

                            if (SORT_TOGGLE == 1)
                                {
                                    for (sindex = 0; sindex < NBsindex;
                                         sindex++)
                                        {
                                            streaminfo[sindex]
                                                .updatevalue_frozen =
                    ...
                    for (dindex = 0; dindex < NBsindex; dindex++)
                        {
                            ...
                            if (DisplayFlag == 1)
                                {
                                    // print file inode
                                    streamCTRL_print_inode(
                                        streamCTRLimages[ID].md[0].inode,
                                        upstreaminode,
                                        NBupstreaminode,
                                        downstreammin);
                                    TUI_printfw(" ");
                        ...
                        TUI_printfw(" ");
                            ...
                            if ((DisplayMode < DISPLAY_MODE_FUSER) &&
                                (DisplayFlag == 1))
                                {
                                    ...
                                    if (streamCTRLimages[streaminfo[sindex].ID]
                                            .md == NULL)
                                        {
                                            sprintf(string, " ???");
                                        }
                                    ...
                                    if (streamCTRLimages[streaminfo[sindex].ID]
                                    ...
                                    else
                                        {
                                            sprintf(str,
                                                    " [%3ld",
                                                    (long) streamCTRLimages[ID]
                                                        .md[0]
                                                        .size[0]);

                                            for (j = 1; j < streamCTRLimages[ID]
                                                                .md[0]
                                                                .naxis;
                                                 j++)
                                                {
                                    ...
                                    if (streamCTRLimages[streaminfo[sindex].ID]
                                    ...
                                    else
                                        {
                                            ...
                                            cpid = streamCTRLimages[ID]
                                                       .md[0]
                                                       .creatorPID;
                                            opid = streamCTRLimages[ID]
                                                       .md[0]
                                                       .ownerPID;
                            ...
                            if (streamCTRLimages[streaminfo[sindex].ID].md !=
                                NULL)
                                {
                                    if ((DisplayMode == DISPLAY_MODE_SEMVAL) &&
                                    ...
                                    if ((DisplayMode == DISPLAY_MODE_SPTRACE) &&
                                        (DisplayFlag == 1)) // sem read PIDs
                                        {
                                            ...
                                            if (DisplayDetailLevel == 1)
                                                {
                                                    TUI_newline();
                                                    streamCTRL_print_SPTRACE_details(
                                                        streamCTRLimages,
                                                        ID,
                                                        upstreamproc,
                                                        NBupstreamproc,
