...
errno_t CLI_checkarg_array(CLICMDARGDEF fpscliarg[], int nbarg)
{
    ...
    if (argindexmatch != -1)
    {
        ...
        if (CLI_checkarg(2, fpscliarg[argindexmatch].type) == 0)
        {
            ...
            case CLIARG_UINT64:
                ...
                break;
            case CLIARG_STR_NOT_IMG:
                strcpy(data.cmd[cmdi].argdata[argindexmatch].val.s, data.cmdargtoken[2].val.string);
                break;
            case CLIARG_IMG:
                strcpy(data.cmd[cmdi].argdata[argindexmatch].val.s, data.cmdargtoken[2].val.string);
                break;
    ...
    for (int arg = 0; arg < nbarg; arg++)
    {
        ...
        if (!(fpscliarg[arg].flag & CLICMDARG_FLAG_NOCLI))
        {
            ...
            DEBUG_TRACEPOINT("  arg %d  CLI %2d  [%7s]  %s", arg, CLIarg, argtypestring, fpscliarg[arg].fpstag);
            ...
            if (CLI_checkarg(CLIarg + 1, fpscliarg[arg].type) == 0)
            {
                ...
                case CLIARG_UINT64:
                    ...
                    break;
                case CLIARG_STR_NOT_IMG:
                    strcpy(data.cmd[cmdi].argdata[arg].val.s, data.cmdargtoken[CLIarg + 1].val.string);
                    break;
                case CLIARG_IMG:
                    strcpy(data.cmd[cmdi].argdata[arg].val.s, data.cmdargtoken[CLIarg + 1].val.string);
                    break;
        ...
        else
        {
            ...
            DEBUG_TRACEPOINT("  arg %d  IGNORED [%7s]  %s", arg, argtypestring, fpscliarg[arg].fpstag);
        }
    }
...
int CLIargs_to_FPSparams_setval(CLICMDARGDEF fpscliarg[], int nbarg, FUNCTION_PARAMETER_STRUCT *fps)
{
    ...
    for (int arg = 0; arg < nbarg; arg++)
    {
        if (!(fpscliarg[arg].flag & CLICMDARG_FLAG_NOFPS))
        {
            ...
            {
            case CLIARG_FLOAT:
                functionparameter_SetParamValue_FLOAT64(fps, fpscliarg[arg].fpstag, data.cmdargtoken[arg + 1].val.numf);
                NBarg_processed++;
                break;

            case CLIARG_FLOAT32:
                functionparameter_SetParamValue_FLOAT32(fps, fpscliarg[arg].fpstag, data.cmdargtoken[arg + 1].val.numf);
                NBarg_processed++;
                break;
            ...
            case CLIARG_LONG:
                functionparameter_SetParamValue_INT64(fps, fpscliarg[arg].fpstag, data.cmdargtoken[arg + 1].val.numl);
                NBarg_processed++;
                break;

            case CLIARG_INT32:
                functionparameter_SetParamValue_INT32(fps, fpscliarg[arg].fpstag, data.cmdargtoken[arg + 1].val.numl);
                NBarg_processed++;
                break;

            case CLIARG_UINT32:
                functionparameter_SetParamValue_UINT32(fps, fpscliarg[arg].fpstag, data.cmdargtoken[arg + 1].val.numl);
                NBarg_processed++;
                break;
            ...
            case CLIARG_UINT64:
                functionparameter_SetParamValue_UINT64(fps, fpscliarg[arg].fpstag, data.cmdargtoken[arg + 1].val.numl);
                NBarg_processed++;
                break;
        ...
        if (!(data.cmd[data.cmdindex].argdata[argi].flag & CLICMDARG_FLAG_NOFPS))
        {
            ...
            case CLIARG_FLOAT32:
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             data.cmd[data.cmdindex].argdata[argi].descr, FPTYPE_FLOAT32,
                                             FPFLAG_DEFAULT_INPUT, &tmpf, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_FLOAT64:
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, &tmplf, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_ONOFF: // default to INT64
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, &tmpvall, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_INT32:
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, &tmpi32, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_UINT32:
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, &tmpui32, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_INT64:
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, &tmpi64, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_UINT64:
            {
                ...
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, &tmpui64, NULL);
                NBarg_processed++;
            }
            break;
            ...
            case CLIARG_STR_NOT_IMG:
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             ...
                                             FPFLAG_DEFAULT_INPUT, data.cmd[data.cmdindex].argdata[argi].val.s, NULL);
                NBarg_processed++;
                break;

            case CLIARG_IMG:
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             data.cmd[data.cmdindex].argdata[argi].descr, FPTYPE_STREAMNAME,
                                             FPFLAG_DEFAULT_INPUT, data.cmd[data.cmdindex].argdata[argi].val.s, NULL);
                NBarg_processed++;
                break;
            ...
            case CLIARG_FILENAME:
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             data.cmd[data.cmdindex].argdata[argi].descr, FPTYPE_FILENAME,
                                             FPFLAG_DEFAULT_INPUT, data.cmd[data.cmdindex].argdata[argi].val.s, NULL);
                NBarg_processed++;
                break;
            ...
            case CLIARG_FITSFILENAME:
                function_parameter_add_entry(fps, data.cmd[data.cmdindex].argdata[argi].fpstag,
                                             data.cmd[data.cmdindex].argdata[argi].descr, FPTYPE_FITSFILENAME,
                                             FPFLAG_DEFAULT_INPUT, data.cmd[data.cmdindex].argdata[argi].val.s, NULL);
                NBarg_processed++;
                break;
            }
...
void *get_farg_ptr(char *tag, long *fpsi)
{
    ...
    if (data.FPS_CMDCODE != 0)
    {
        ...
        ptr = (void *)functionparameter_GetParamPtr_generic(data.fpsptr, tag, fpsi);
    }
    else
    {
        for (int argi = 0; argi < data.cmd[data.cmdindex].nbarg; argi++)
