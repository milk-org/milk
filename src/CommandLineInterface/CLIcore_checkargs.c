...
static int CLI_checkarg0(int argnum, uint32_t argtype, int errmsg)
{
    ...
    if (strcmp(data.cmdargtoken[argnum].val.string, "?") == 0)
        {
            argcheck_process_flag =
                0; // stop processing arguments, will call help
            ...
            switch (data.cmdargtoken[argnum].type)
                ...
                case CLIARG_FLOAT:
                    ...
                    if (errmsg == 1)
                        {
                            printf(
                                "converting floating point arg %d to integer\n",
                                argnum - 1);
                        }
                    data.cmdargtoken[argnum].val.numl =
            ...
            switch (data.cmdargtoken[argnum].type)
                ...
                case CLIARG_LONG: // if long -> not OK
                    ...
                    if (errmsg == 1)
                        {
                            printf(
                                "  arg %d (integer %ld) not a non-img-string\n",
                                argnum - 1,
                                data.cmdargtoken[argnum].val.numl);
                        }
                    rval = 1;
                ...
                case CLIARG_STR: // if string -> not OK
                    printf(
                        "arg %d is command (=\"%s\"), but should be string\n",
                        argnum,
                        data.cmdargtoken[argnum].val.string);
                    rval = 1;
                    break;
            ...
            switch (data.cmdargtoken[argnum].type)
                ...
                case CLIARG_FLOAT: // if float -> not OK
                    ...
                    if (errmsg == 1)
                        {
                            printf(
                                "  arg %d (float %f) not a string or image\n",
                                argnum - 1,
                                data.cmdargtoken[argnum].val.numf);
                        }
                    rval = 1;
                ...
                case CLIARG_LONG: // if long -> not OK
                    ...
                    if (errmsg == 1)
                        {
                            printf(
                                "  arg %d (integer %ld) not string or image\n",
                                argnum - 1,
                                data.cmdargtoken[argnum].val.numl);
                        }
                    rval = 1;
...
errno_t CLI_checkarg_array(CLICMDARGDEF fpscliarg[], int nbarg)
{
    ...
    for (int arg = 0; arg < nbarg; arg++)
        {
            if (strcmp(data.cmdargtoken[1].val.string, fpscliarg[arg].fpstag) ==
                0)
                {
                    argindexmatch = arg;
                }
            ...
            if (!(fpscliarg[arg].flag & CLICMDARG_FLAG_NOCLI))
                {
                    ...
                    if (strcmp(data.cmdargtoken[CLIarg + 1].val.string, ".") ==
                        0)
                        {
                            ...
                            switch (fpscliarg[arg].type) // & 0x0000FFFF)
                                ...
                                case CLIARG_FLOAT32: // if desired type is float single precision
                                    ...
                                    data.cmdargtoken[CLIarg + 1].type =
                                        CLIARG_FLOAT;
                                    break;
                    ...
                    if (CLI_checkarg(CLIarg + 1, fpscliarg[arg].type) == 0)
                        {
                            DEBUG_TRACEPOINT(
                                "successful parsing, update default to last");
                            switch (fpscliarg[arg].type) // & 0x0000FFFF)
                                {
                                case CLIARG_FLOAT32:
                                    data.cmd[cmdi].argdata[arg].val.f32 =
            ...
            if (!(data.cmd[data.cmdindex].argdata[argi].flag &
                  CLICMDARG_FLAG_NOFPS))
                {
                    ...
                    switch (data.cmd[data.cmdindex].argdata[argi].type)
                        ...
                        case CLIARG_FLOAT32:
                            {
                                float tmpf = data.cmd[data.cmdindex]
                                                 .argdata[argi]
                                                 .val.f32;
                        ...
                        case CLIARG_FLOAT64:
                            {
                                double tmplf = data.cmd[data.cmdindex]
                                                   .argdata[argi]
                                                   .val.f64;
                                function_parameter_add_entry(
                                    fps,
                        ...
                        case CLIARG_ONOFF: // default to INT64
                            {
                                tmpvall = data.cmd[data.cmdindex]
                                              .argdata[argi]
                                              .val.ui64;
                                function_parameter_add_entry(
                                    fps,
                 ...
                 break;*/
                        ...
                        case CLIARG_INT32:
                            {
                                int32_t tmpi32 = data.cmd[data.cmdindex]
                                                     .argdata[argi]
                                                     .val.i32;
                                function_parameter_add_entry(
                                    fps,
                        ...
                        case CLIARG_UINT32:
                            {
                                uint32_t tmpui32 = data.cmd[data.cmdindex]
                                                       .argdata[argi]
                                                       .val.ui32;
                                function_parameter_add_entry(
                                    fps,
                        ...
                        case CLIARG_INT64:
                            {
                                int64_t tmpi64 = data.cmd[data.cmdindex]
                                                     .argdata[argi]
                                                     .val.i64;
                                function_parameter_add_entry(
                                    fps,
                        ...
                        case CLIARG_UINT64:
                            {
                                uint64_t tmpui64 = data.cmd[data.cmdindex]
                                                       .argdata[argi]
                                                       .val.ui64;
                                function_parameter_add_entry(
                                    fps,
...
void *get_farg_ptr(char *tag, long *fpsi)
{
    ...
    if (data.FPS_CMDCODE != 0)
    ...
    else
        {
            for (int argi = 0; argi < data.cmd[data.cmdindex].nbarg; argi++)
                {
                    if (strcmp(data.cmd[data.cmdindex].argdata[argi].fpstag,
                               tag) == 0)
                        {
                            ptr = (void *) (&data.cmd[data.cmdindex]
                                                 .argdata[argi]
                                                 .val);
                            break;
                        }
