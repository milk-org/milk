                                     ...
                                     long       *pindexptr)
{
    ...
    for (pindexscan = 0; pindexscan < NBparamMAX; pindexscan++)
        {
            if (strcmp(keywordstringC,
                       funcparamarray[pindexscan].keywordfull) == 0)
                {
                    pindex = pindexscan;
                    scanOK = 1;
                }
                    ...
                    switch (funcparamarray[pindex].type)
                        ...
                        case FPTYPE_INT32:
                            ...
                            funcparamarray[pindex].val.i32[0] =
                                valueptr_INT32[0];
                            funcparamarray[pindex].val.i32[1] =
                                valueptr_INT32[1];
                            funcparamarray[pindex].val.i32[2] =
                                valueptr_INT32[2];
                            funcparamarray[pindex].val.i32[3] =
                                valueptr_INT32[3];
                        ...
                        case FPTYPE_UINT32:
                            ...
                            funcparamarray[pindex].val.ui32[0] =
                                valueptr_UINT32[0];
                            funcparamarray[pindex].val.ui32[1] =
                                valueptr_UINT32[1];
                            funcparamarray[pindex].val.ui32[2] =
                                valueptr_UINT32[2];
                            funcparamarray[pindex].val.ui32[3] =
                                valueptr_UINT32[3];
                            funcparamarray[pindex].cnt0++;
                            break;
                        ...
                        case FPTYPE_INT64:
                            ...
                            funcparamarray[pindex].val.i64[0] =
                                valueptr_INT64[0];
                            funcparamarray[pindex].val.i64[1] =
                                valueptr_INT64[1];
                            funcparamarray[pindex].val.i64[2] =
                                valueptr_INT64[2];
                            funcparamarray[pindex].val.i64[3] =
                                valueptr_INT64[3];
                            funcparamarray[pindex].cnt0++;
                            break;
                        ...
                        case FPTYPE_UINT64:
                            ...
                            funcparamarray[pindex].val.ui64[0] =
                                valueptr_UINT64[0];
                            funcparamarray[pindex].val.ui64[1] =
                                valueptr_UINT64[1];
                            funcparamarray[pindex].val.ui64[2] =
                                valueptr_UINT64[2];
                            funcparamarray[pindex].val.ui64[3] =
                                valueptr_UINT64[3];
                            funcparamarray[pindex].cnt0++;
                            break;
                        ...
                        case FPTYPE_FLOAT64:
                            ...
                            funcparamarray[pindex].val.f64[0] =
                                valueptr_FLOAT64[0];
                            funcparamarray[pindex].val.f64[1] =
                                valueptr_FLOAT64[1];
                            funcparamarray[pindex].val.f64[2] =
                                valueptr_FLOAT64[2];
                            funcparamarray[pindex].val.f64[3] =
                                valueptr_FLOAT64[3];
                            funcparamarray[pindex].cnt0++;
                            break;
                        ...
                        case FPTYPE_FLOAT32:
                            ...
                            funcparamarray[pindex].val.f32[0] =
                                valueptr_FLOAT32[0];
                            funcparamarray[pindex].val.f32[1] =
                                valueptr_FLOAT32[1];
                            funcparamarray[pindex].val.f32[2] =
                                valueptr_FLOAT32[2];
                            funcparamarray[pindex].val.f32[3] =
                                valueptr_FLOAT32[3];
                            funcparamarray[pindex].cnt0++;
                            break;
