...
errno_t function_parameter_add_entry(FUNCTION_PARAMETER_STRUCT *fps, const char *keywordstring,
                                     const char *descriptionstring, uint64_t type, uint64_t fpflag, void *valueptr,
                                     long *pindexptr)
{
    ...
    if (scanOK == 0) // not found
    {
        ...
        while (pch != NULL)
        {
            strncpy(funcparamarray[pindex].keyword[funcparamarray[pindex].keywordlevel], pch,
        ...
        // Write description
        strncpy(funcparamarray[pindex].description, descriptionstring, FUNCTION_PARAMETER_DESCR_STRMAXLEN - 1);
        ...
        case FPTYPE_FILENAME:
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN, "NULLFNAME");
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[1], FUNCTION_PARAMETER_STRMAXLEN, "NULLFNAME");
            break;

        case FPTYPE_FITSFILENAME:
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN, "NULLFITS");
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[1], FUNCTION_PARAMETER_STRMAXLEN, "NULLFITS");
            break;

        case FPTYPE_EXECFILENAME:
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN, "NULLEXEC");
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[1], FUNCTION_PARAMETER_STRMAXLEN, "NULLEXEC");
            break;

        case FPTYPE_DIRNAME:
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN, "NULLDIR");
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[1], FUNCTION_PARAMETER_STRMAXLEN, "NULLDIR");
            break;

        case FPTYPE_STREAMNAME:
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN, "NULLSTREAM");
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[1], FUNCTION_PARAMETER_STRMAXLEN, "NULLSTREAM");
            break;

        case FPTYPE_STRING:
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN, "NULLSTRING");
            SNPRINTF_CHECK(funcparamarray[pindex].val.string[1], FUNCTION_PARAMETER_STRMAXLEN, "NULLSTRING");
            break;
        ...
        if (valueptr != NULL) // allocate value requested by function call
        {
            ...
            case FPTYPE_FILENAME:
                strncpy(funcparamarray[pindex].val.string[0], (char *)valueptr, FUNCTION_PARAMETER_STRMAXLEN - 1);
                funcparamarray[pindex].cnt0++;
                break;
