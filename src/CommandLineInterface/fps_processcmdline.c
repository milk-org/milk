                                         ...
                                         FUNCTION_PARAMETER_STRUCT *fps, uint64_t *taskstatus)
{
    ...
    *taskstatus |= FPSTASK_STATUS_RECEIVED;
    ...
    if ((cmdFOUND == 0) && (strcmp(FPScommand, "rescan") == 0))
    {
        ...
        {
            functionparameter_scan_fps(fpsCTRLvar->mode, fpsCTRLvar->fpsnamemask, fps, keywnode, &fpsCTRLvar->NBkwn,
    ...
    if (kwnindex != -1) // if FPS has been found
    {
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "tmuxstart") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("TMUXSTART", "Init tmux session %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "tmuxstop") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("TMUXSTOP", "Init tmux session %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "confstart") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("CONFSTART", "start CONF process %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "confstop") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("CONFSTOP", "stop CONF process %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "confupdate") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("CONFUPDATE", "update CONF process %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "confwupdate") == 0))
        {
            ...
            else
            {
                ...
                while (looptry == 1)
                {
                    ...
                    functionparameter_outlog("CONFWUPDATE", "[%d] waited %d us on FPS %d %s. conferrcnt = %d",
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "runstart") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("RUNSTART", "start RUN process %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "runwait") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("RUNWAIT", "waited %d us on FPS %d %s", dt * timercnt, fpsindex,
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "runstop") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("RUNSTOP", "stop RUN process %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "fpsrm") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("FPSRM", "FPS remove %d %s", fpsindex, fps[fpsindex].md->name);
                cmdOK = 1;
            }
        }
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "exec") == 0))
        {
            ...
            else
            {
                ...
                {
                    EXECUTE_SYSTEM_COMMAND("tmux send-keys -t %s:run \"cd %s\" C-m", fps[fpsindex].md->name,
                                           fps[fpsindex].md->workdir);
                    EXECUTE_SYSTEM_COMMAND("tmux send-keys -t %s:run \"%s %s\" C-m", fps[fpsindex].md->name,
        ...
        if ((cmdFOUND == 0) && (strcmp(FPScommand, "setval") == 0))
        {
            ...
            else
            {
                ...
                case FPTYPE_INT32:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_INT32(&fps[fpsindex], FPSentryname, valn) == EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s INT32      %ld", FPSentryname, valn);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_UINT32:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_UINT32(&fps[fpsindex], FPSentryname, valn) == EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s UINT32     %ld", FPSentryname, valn);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_INT64:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_INT64(&fps[fpsindex], FPSentryname, valn) == EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s INT64      %ld", FPSentryname, valn);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_UINT64:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_UINT64(&fps[fpsindex], FPSentryname, valn) == EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s UINT64     %ld", FPSentryname, valn);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_FLOAT64:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_FLOAT64(&fps[fpsindex], FPSentryname, valf64) ==
                            EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s FLOAT64     %f", FPSentryname, valf64);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_FLOAT32:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_FLOAT32(&fps[fpsindex], FPSentryname, valf32) ==
                            EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s FLOAT32     %f", FPSentryname, valf32);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_PID:
                {
                    ...
                    if (*endptr == '\0')
                    {
                        ...
                        if (functionparameter_SetParamValue_INT64(&fps[fpsindex], FPSentryname, valn) == EXIT_SUCCESS)
                        {
                            ...
                            functionparameter_outlog("SETVAL", "%-40s PID      %ld", FPSentryname, valn);
                        }
                    }
                    else
                    {
                ...
                case FPTYPE_TIMESPEC:
                {
                    ...
                    {
                        // OK
                        if (functionparameter_SetParamValue_TIMESPEC(&fps[fpsindex], FPSentryname, valf32) ==
                            EXIT_SUCCESS)
                        {
                            updated = 1;

                            functionparameter_outlog("SETVAL", "%-40s TIMESPEC     %f", FPSentryname, valf32);
                        }
                    }
                    else
                    {
                        *taskstatus |= FPSTASK_STATUS_ERR_TYPECONV;
                        cmdOK = 0;
                        SNPRINTF_CHECK(errmsgstring, STRINGMAXLEN_FPS_LOGMSG, "argument is not FLOAT->TIMESPEC");
                        functionparameter_outlog("ERROR", "%s", errmsgstring);
                    }
                }
                break;
                ...
                case FPTYPE_FILENAME:
                    if (functionparameter_SetParamValue_STRING(&fps[fpsindex], FPSentryname, FPScmdarg1) ==
                        EXIT_SUCCESS)
                    {
                        updated = 1;
                    }
                    functionparameter_outlog("SETVAL", "%-40s FILENAME   %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                case FPTYPE_FITSFILENAME:
                    ...
                    functionparameter_outlog("SETVAL", "%-40s FITSFILENAME   %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                case FPTYPE_EXECFILENAME:
                    ...
                    functionparameter_outlog("SETVAL", "%-40s EXECFILENAME   %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                case FPTYPE_DIRNAME:
                    ...
                    functionparameter_outlog("SETVAL", "%-40s DIRNAME    %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                case FPTYPE_STREAMNAME:
                    ...
                    functionparameter_outlog("SETVAL", "%-40s STREAMNAME %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                case FPTYPE_STRING:
                    ...
                    functionparameter_outlog("SETVAL", "%-40s STRING     %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                case FPTYPE_ONOFF:
                    if (strncmp(FPScmdarg1, "ON", 2) == 0)
                    {
                        ...
                        functionparameter_outlog("SETVAL", "%-40s ONOFF      ON", FPSentryname);
                    }
                    if (strncmp(FPScmdarg1, "OFF", 3) == 0)
                    {
                        ...
                        functionparameter_outlog("SETVAL", "%-40s ONOFF      OFF", FPSentryname);
                    }
                    break;
                ...
                case FPTYPE_FPSNAME:
                    ...
                    functionparameter_outlog("SETVAL", "%-40s FPSNAME   %s", FPSentryname, FPScmdarg1);
                    break;
                ...
                {
                    cmdOK = 1;
                    functionparameter_WriteParameterToDisk(&fps[fpsindex], pindex, "setval", "InputCommandFile");
        ...
        // getval or fwrval
        if ((cmdFOUND == 0) && ((strcmp(FPScommand, "getval") == 0) || (strcmp(FPScommand, "fwrval") == 0)))
        {
            cmdFOUND = 1;
            cmdOK = 0;
            ...
            {
                errno_t ret;
                ret = functionparameter_PrintParameter_ValueString(&fps[fpsindex].parray[pindex], msgstring,
                                         ...
                                         FPSCTRL_TASK_QUEUE *fpsctrlqueuelist, FPSCTRL_PROCESS_VARS *fpsCTRLvar)
{
    ...
    if (fpinputcmd != NULL)
    {
        ...
        while ((read = getline(&FPScmdline, &len, fpinputcmd)) != -1)
        {
            ...
            functionparameter_FPSprocess_cmdline(FPScmdline, fpsctrlqueuelist, keywnode, fpsCTRLvar, fps, &taskstatus);
        }
        fclose(fpinputcmd);
    }
