            ...
            if (nbword > 1)
                {
                    ...
                    int kwnindexscan = 0;
                    while ((kwnindex == -1) &&
                           (kwnindexscan < fpsCTRLvar->NBkwn))
                        {
                            if (strcmp(keywnode[kwnindexscan].keywordfull,
                                       FPSentryname) == 0)
                                {
                            ...
                            while (looptry == 1)
                                {
                                    ...
                                    if (timercnt >
                                        timercntmax) // ran out of time ... giving up
                                        {
                                            looptry = 0;
                                        }
                                }
            ...
            if ((cmdFOUND == 0) && (strcmp(FPScommand, "fpsrm") == 0))
                {
                    ...
                    if (nbword != 2)
                        ...
                        {
                            DEBUG_TRACEPOINT("Removing fps number %d",
                                             fpsindex);
            ...
            if ((cmdFOUND == 0) && (strcmp(FPScommand, "exec") == 0))
                {
                    ...
                    if (nbword != 2)
                        ...
                        {
                            DEBUG_TRACEPOINT(" ");
                            if (fps[fpsindex].parray[pindex].type ==
                                FPTYPE_EXECFILENAME)
                                {
                    ...
                    if ((strcmp(FPScommand, "getval") == 0) && (nbword != 2))
                        {
                            functionparameter_outlog(
                                "ERROR",
                                "COMMAND getval NBARGS = 1");
                        }
                    else if ((strcmp(FPScommand, "fwrval") == 0) &&
                             (nbword != 3))
                        {
                            functionparameter_outlog(
                                "ERROR",
                                "COMMAND fwrval NBARGS = 2");
                        }
                    else
                        {
                            errno_t ret;
                            ...
                            if (cmdOK == 1)
                                {
                                    if (strcmp(FPScommand, "getval") == 0)
                                        {
                                            functionparameter_outlog("GETVAL",
                                                                     "%s",
                                                                     msgstring);
                                        }
                                    if (strcmp(FPScommand, "fwrval") == 0)
                                        {
                                            ...
                                            functionparameter_outlog("FWRVAL",
                                                                     "%s",
                                                                     msgstring);
                                            char msgstring1
                                                [STRINGMAXLEN_FPS_LOGMSG];
