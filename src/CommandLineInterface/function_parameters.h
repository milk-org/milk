...
#define FPFLAG_FILE_CONF_REQUIRED                                              \
    0x0000000040000000 // file must exist for CONF process to proceed
#define FPFLAG_FILE_RUN_REQUIRED                                               \
    0x0000000080000000 // file must exist for RUN process to proceed
...
#define FPFLAG_STREAM_CONF_REQUIRED                                            \
    0x0000000040000000 // stream has to be in MEM for CONF process to proceed
#define FPFLAG_STREAM_RUN_REQUIRED                                             \
    0x0000000080000000 // stream has to be in MEM for RUN process to proceed
...
#define FPFLAG_STREAM_ENFORCE_DATATYPE                                         \
    0x0000000100000000 // enforce stream datatype
...
#define FPFLAG_STREAM_TEST_DATATYPE_INT8                                       \
    0x0000000400000000 // test if stream of type INT8    (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_UINT16                                     \
    0x0000000800000000 // test if stream of type UINT16  (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_INT16                                      \
    0x0000001000000000 // test if stream of type INT16   (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_UINT32                                     \
    0x0000002000000000 // test if stream of type UINT32  (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_INT32                                      \
    0x0000004000000000 // test if stream of type INT32   (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_UINT64                                     \
    0x0000008000000000 // test if stream of type UINT64  (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_INT64                                      \
    0x0000010000000000 // test if stream of type INT64   (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_HALF                                       \
    0x0000020000000000 // test if stream of type HALF    (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_FLOAT                                      \
    0x0000040000000000 // test if stream of type FLOAT   (OR test)
#define FPFLAG_STREAM_TEST_DATATYPE_DOUBLE                                     \
    0x0000080000000000 // test if stream of type DOUBLE  (OR test)
...
#define FPFLAG_CHECKSTREAM                                                     \
    0x0040000000000000 // check and display stream status in GUI
#define FPFLAG_STREAM_MEMLOADREPORT                                            \
    0x0080000000000000 // Write stream load report (for debugging)

// PRE-ASSEMBLED DEFAULT FLAGS

// input parameter (used as default when adding entry)
#define FPFLAG_DEFAULT_INPUT                                                   \
    FPFLAG_ACTIVE | FPFLAG_USED | FPFLAG_VISIBLE | FPFLAG_WRITE |              \
        FPFLAG_WRITECONF | FPFLAG_SAVEONCHANGE | FPFLAG_FEEDBACK |             \
        FPFLAG_WRITESTATUS
#define FPFLAG_DEFAULT_OUTPUT FPFLAG_ACTIVE | FPFLAG_USED | FPFLAG_VISIBLE
#define FPFLAG_DEFAULT_INPUT_STREAM                                            \
    FPFLAG_DEFAULT_INPUT | FPFLAG_STREAM_RUN_REQUIRED | FPFLAG_CHECKSTREAM
...
#define FUNCTION_PARAMETER_STRUCT_STATUS_CONF                                  \
    0x0001 // is configuration running ?
#define FUNCTION_PARAMETER_STRUCT_STATUS_RUN 0x0002 // is process running ?

#define FUNCTION_PARAMETER_STRUCT_STATUS_CMDCONF                               \
    0x0010 // should configuration be running ?
#define FUNCTION_PARAMETER_STRUCT_STATUS_CMDRUN                                \
    0x0020 // should process be running ?

#define FUNCTION_PARAMETER_STRUCT_STATUS_RUNLOOP                               \
    0x0100 // is process loop running ?
#define FUNCTION_PARAMETER_STRUCT_STATUS_CHECKOK                               \
    0x0200 // Are parameter values OK to run loop process ? (1=OK, 0=not OK)
...
#define FUNCTION_PARAMETER_STRUCT_SIGNAL_UPDATE                                \
    0x0004 // re-run check of parameter

#define FUNCTION_PARAMETER_STRUCT_SIGNAL_CHECKED                               \
    0x0008 // CheckParametersAll been completed.
...
// flags
#define FPSTASK_STATUS_ACTIVE                                                  \
    0x0000000000000001 // is the task entry in the array used ?
...
#include "fps/fps_RUNexit.h"
#include "fps/fps_add_entry.h"
#include "fps/fps_checkparameter.h"
#include "fps/fps_connect.h"
#include "fps/fps_connectExternalFPS.h"
#include "fps/fps_disconnect.h"
#include "fps/fps_execFPScmd.h"
#include "fps/fps_getFPSargs.h"
#include "fps/fps_load.h"
#include "fps/fps_outlog.h"
#include "fps/fps_paramvalue.h"
