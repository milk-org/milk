...
#define FPFLAG_DEFAULT_INPUT                                                                                           \
    FPFLAG_ACTIVE | FPFLAG_USED | FPFLAG_VISIBLE | FPFLAG_WRITE | FPFLAG_WRITECONF | FPFLAG_SAVEONCHANGE |             \
...
#define FPS_SETUP_INIT(VARfpsname, VARCMDmode)                                                                         \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            SNPRINTF_CHECK(msgstring, STRINGMAXLEN_FPS_LOGMSG, "LOGSTART %s %d %s %d", (VARfpsname), (VARCMDmode),     \
