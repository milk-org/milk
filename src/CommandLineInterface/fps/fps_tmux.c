...
)
{
    ...
    EXECUTE_SYSTEM_COMMAND("tmux send-keys -t %s:ctrl \"./setfpstmuxenv\" C-m",
                           fps->md->name);
    ...
    EXECUTE_SYSTEM_COMMAND("tmux send-keys -t %s:conf \"./setfpstmuxenv\" C-m",
                           fps->md->name);
    ...
    EXECUTE_SYSTEM_COMMAND("tmux send-keys -t %s:run \"./setfpstmuxenv\" C-m",
                           fps->md->name);
