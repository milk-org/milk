        ...
        if (esc_toggle == 0) // update value if escape key has not been pressed
        {
            ...
            case FPTYPE_INT32:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s INT32 %ld",
                                             fpsentry->parray[pindex].keywordfull, lval);
                }
                break;
            ...
            case FPTYPE_UINT32:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s UINT32 %ld",
                                             fpsentry->parray[pindex].keywordfull, lval);
                }
                break;
            ...
            case FPTYPE_INT64:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s INT64 %ld",
                                             fpsentry->parray[pindex].keywordfull, lval);
                }
                break;
            ...
            case FPTYPE_UINT64:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s UINT64 %ld",
                                             fpsentry->parray[pindex].keywordfull, lval);
                }
                break;
            ...
            case FPTYPE_FLOAT64:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s FLOAT64 %g",
                                             fpsentry->parray[pindex].keywordfull, fval);
                }
                break;
            ...
            case FPTYPE_FLOAT32:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s FLOAT32 %g",
                                             fpsentry->parray[pindex].keywordfull, fval);
                }
                break;
            ...
            case FPTYPE_TIMESPEC:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s TIMESPEC %ld.%09ld",
            ...
            case FPTYPE_PID:
                ...
                if (vOK == 1)
                {
                    ...
                    functionparameter_outlog("SETVAL", "%s PID %ld",
                                             fpsentry->parray[pindex].keywordfull, lval);
                }
                break;

            case FPTYPE_FILENAME:
                if (snprintf(fpsentry->parray[pindex].val.string[0], FUNCTION_PARAMETER_STRMAXLEN,
                             "%s", buff) < 0)
                {
                ...
                {
                    functionparameter_outlog("SETVAL", "%s FILENAME %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            ...
            case FPTYPE_FITSFILENAME:
                ...
                {
                    functionparameter_outlog("SETVAL", "%s FITSFILENAME %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            ...
            case FPTYPE_EXECFILENAME:
                ...
                {
                    functionparameter_outlog("SETVAL", "%s EXECFILENAME %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            ...
            case FPTYPE_DIRNAME:
                ...
                {
                    functionparameter_outlog("SETVAL", "%s DIRNAME %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            ...
            case FPTYPE_STREAMNAME:
                ...
                {
                    functionparameter_outlog("SETVAL", "%s STREAMNAME %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            ...
            case FPTYPE_STRING:
                ...
                {
                    functionparameter_outlog("SETVAL", "%s STRING %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            ...
            case FPTYPE_FPSNAME:
                ...
                {
                    functionparameter_outlog("SETVAL", "%s FPSNAME %s",
                                             fpsentry->parray[pindex].keywordfull, buff);
                }
                break;
            }
