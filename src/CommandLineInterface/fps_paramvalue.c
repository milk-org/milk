...
errno_t function_parameter_SetValue_int64(char *keywordfull, int64_t val)
{
    ...
    strncpy(tmpstring, keywordfull, FUNCTION_PARAMETER_KEYWORD_STRMAXLEN * FUNCTION_PARAMETER_KEYWORD_MAXLEVEL - 1);
    keywordlevel = 0;
...
int functionparameter_SetParamValue_STRING(FUNCTION_PARAMETER_STRUCT *fps, const char *paramname,
