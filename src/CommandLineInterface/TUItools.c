...
void TUI_set_screenprintmode(int mode) { screenprintmode = mode; }

int TUI_get_screenprintmode() { return screenprintmode; }
...
errno_t TUI_inittermios(short unsigned int *wrowptr, short unsigned int *wcolptr)
{
