    ...
    if (screenprintmode == SCREENPRINT_NCURSES)
        {
            ...
            getmaxyx(stdscr,
                     wrow,
                     wcol); /* get the number of rows and columns */
            *wrowptr = wrow;
            *wcolptr = wcol;
                          ...
                          short unsigned int *wcolptr)
{
    if (screenprintmode == SCREENPRINT_NCURSES) // ncurses mode
    ...
    else
        {
            ...
            DEBUG_TRACEPOINT("init terminal stdio mode %d %d",
                             *wrowptr,
                             *wcolptr);
        }
                            ...
                            if (buff[1] == 91)
                                {
                                    switch (buff[2])
                                        ...
                                        case 'B':
                                            ch =
                                                KEY_DOWN; // code for arrow down
                                            break;
                                        case 'C':
                                            ch =
                                                KEY_RIGHT; // code for arrow right
                                            break;
                                        case 'D':
                                            ch =
                                                KEY_LEFT; // code for arrow left
                                            break;
                                        }
                                }
