...
#define TREE_SITTER_MIN_COMPATIBLE_LANGUAGE_VERSION 13
    ...
    typedef uint32_t (*TSDecodeFunction)(const uint8_t *string,
                                         uint32_t       length,
                                         int32_t       *code_point);
 ...
 */
    TSTree *ts_parser_parse_with_options(TSParser      *self,
 ...
 */
    TSNode ts_tree_root_node_with_offset(const TSTree *self,
 ...
 */
    void ts_query_cursor_exec_with_options(TSQueryCursor              *self,
                                           const TSQuery              *query,
                                           TSNode                      node,
 ...
 * it will return `true`.
 */
    bool ts_query_cursor_set_byte_range(TSQueryCursor *self,
                                        uint32_t       start_byte,
                                        uint32_t       end_byte);
 ...
 * it will return `true`.
 */
    bool ts_query_cursor_set_point_range(TSQueryCursor *self,
                                         TSPoint        start_point,
                                         TSPoint        end_point);
 ...
 */
    bool ts_query_cursor_set_containing_byte_range(TSQueryCursor *self,
                                                   uint32_t       start_byte,
                                                   uint32_t       end_byte);
 ...
 * long as they are fully contained within lines 4500-5500
 */
    bool ts_query_cursor_set_containing_point_range(TSQueryCursor *self,
                                                    TSPoint        start_point,
                                                    TSPoint        end_point);
 ...
 */
    const TSSymbol *ts_language_subtypes(const TSLanguage *self,
                                         TSSymbol          supertype,
                                         uint32_t         *length);
 ...
 */
    const TSLanguage *ts_wasm_store_load_language(TSWasmStore *,
                                                  const char  *name,
                                                  const char  *wasm,
                                                  uint32_t     wasm_len,
                                                  TSWasmError *error);
