 ...
 * ----------------------------------------------------------------------- */
static inline void tv_move(char *buf, size_t *pos, int row, int col)
{
 ...
 * ----------------------------------------------------------------------- */
static inline void tv_bg(char *buf, size_t *pos, uint8_t r, uint8_t g, uint8_t b)
{
    /* Static prefix bytes */
    buf[(*pos)++] = '\033';
    buf[(*pos)++] = '[';
 ...
 * ----------------------------------------------------------------------- */
static inline void tv_fg(char *buf, size_t *pos, uint8_t r, uint8_t g, uint8_t b)
{
    buf[(*pos)++] = '\033';
    buf[(*pos)++] = '[';
    buf[(*pos)++] = '3';
