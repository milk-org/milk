 ...
 */
static int expand_fpsvar_procinfo_strict(
    char *pname,
    char *out,
    int  *opos,
    int  maxlen)
 ...
 */
static int expand_fpsvar_stream(
    char *pname,
    char *out,
    int  *opos,
    int  maxlen)
 ...
 */
static int expand_fpsvar_fps_strict(
    char *pname,
    char *out,
    int  *opos,
    int  maxlen)
            ...
            && opos < maxlen - 1)
    {
           ...
           && !in_double)
        {
            ...
            *dot = '\0';
            ...
            else if(strcmp(fpsname,
                           "proc") == 0)
            {
                if(expand_fpsvar_procinfo_strict(
                       pname, out, &opos,
                       maxlen) != 0)
                {
                    continue;
            ...
            else if(strcmp(fpsname, "s") == 0
                    || strcmp(fpsname,
                              "stream") == 0)
            {
                if(expand_fpsvar_stream(
                       pname, out, &opos,
                       maxlen) != 0)
                {
                    continue;
