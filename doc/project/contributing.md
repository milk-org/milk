# Contribution overview -- top level file
...
#TODO for low-rank devs, summarize what they need to know at the top here.
#FIXME check summary is up-to-date.

The goal is that all the (boring) rules come down to automation.


## Overarching philosophy

Just like in scientific writing (but less serious): please be concise and precise.

In issue reporting, ensure reproducibility, and work towards a M(n)WE of the issue.
...
- As a module-dev, you'd be expected to...
  - Maintain your own docs, make sure your module compiles with all the flags it may use.
  - Make sure you module is found and linked and usable the way you intend to.
- As a core-dev.
  - You're touching the milk engine, core module libraries, and/or common routines that are used by a variety of packages.
  - You're expected to discuss your features, document your work, provide testing, argue for significant changes (including of course your own intended application)
- As a maintainer...
  - Expected to be able to run the _whole_ test suite, compile and test under all reasonable combinations, maintain and change the workflows, dockerfiles, testing files, etc.

----- WORKZONE -----

> [!TIP]
> This is how I write markdown boxes
