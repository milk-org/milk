...
| CLI error help            | [`cli-error-help.md`](https://github.com/milk-org/milk/blob/framework-dev/.agents/rules/cli-error-help.md)                                               | Print red error + colored help on CLI argument errors.                               |
...
| Const correctness         | [`const-correctness.md`](https://github.com/milk-org/milk/blob/framework-dev/.agents/rules/const-correctness.md)                                         | Use `const` on read-only pointer params and input pixel-data pointers.               |
...
| Lib vs app error handling | [`library-vs-application-error-handling.md`](https://github.com/milk-org/milk/blob/framework-dev/.agents/rules/library-vs-application-error-handling.md) | Libraries return errors; only app entry points may call `exit()`.                    |
...
| Parameter alignment       | [`parameter-alignment.md`](https://github.com/milk-org/milk/blob/framework-dev/.agents/rules/parameter-alignment.md)                                     | Column-align parameter names in multi-line prototypes.                               |
...
| Stream modifier guide      | [`stream-modifier-guide`](https://github.com/milk-org/milk/blob/framework-dev/.agents/skills/stream-modifier-guide/SKILL.md)           | IMGID parsing pipeline, `@S:`/`@L:` modifiers, slice syntax.                                    |
