...
static CLICMDARGDEF farg[] = {
    { CLIARG_STR, ".outim", "output image", "outim", CLIARG_VISIBLE_DEFAULT, (void **) &outimname,
      NULL },
    { CLIARG_INT64, ".size", "size", "512", CLIARG_VISIBLE_DEFAULT, (void **) &sizeout, NULL },
    { CLIARG_INT64, ".kmax", "k max", "100", CLIARG_VISIBLE_DEFAULT, (void **) &kmaxval, NULL },
    { CLIARG_FLOAT64, ".radius", "radius [pix]", "160.0", CLIARG_VISIBLE_DEFAULT,
      (void **) &radiusval, NULL },
    { CLIARG_FLOAT64, ".rfactlim", "radius factor limit", "2.0", CLIARG_VISIBLE_DEFAULT,
      (void **) &radfactorlimval, NULL }
};

static CLICMDDATA CLIcmddata = { "mkcosrmodes", "make basis of cosine radial modes",
