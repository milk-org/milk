...
static CLICMDARGDEF farg[] = {
    ...
    { CLIARG_STR, ".outim", "output image", "outim", CLIARG_VISIBLE_DEFAULT, (void **) &outimname,
      NULL },
    { CLIARG_FLOAT64, ".svdeps", "SVD cutoff", "0.001", CLIARG_VISIBLE_DEFAULT,
      (void **) &SVD_epsilon, NULL },
    { CLIARG_INT64, ".maxNBmode", "Maximum NB modes", "10000", CLIARG_VISIBLE_DEFAULT,
      (void **) &max_NBmodes, NULL },
    { CLIARG_STR, ".outimVT", "output VT matrix", "outVTmat", CLIARG_VISIBLE_DEFAULT,
      (void **) &outimVTmatname, NULL },
    { CLIARG_INT64, ".GPU", "use GPU", "0", CLIARG_HIDDEN_DEFAULT, (void **) &useGPU, NULL }
};
                                        ...
                                        imageID    *outID) /* works for m != n */
{
    ...
    FUNC_CHECK_RETURN(
        create_image_ID(ID_VTmatrix_name, 2, arraysizetmp, datatype, 0, 0, 0, &ID_VTmatrix));
