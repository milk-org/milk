...
static CLICMDARGDEF farg[] = {
    { CLIARG_STR, ".out_name", "output image", "out1", CLIARG_VISIBLE_DEFAULT, (void **) &outimname,
      NULL },
    { CLIARG_UINT32, ".sizex", "sizex", "512", CLIARG_VISIBLE_DEFAULT, (void **) &sizexout, NULL },
    { CLIARG_UINT32, ".sizey", "sizey", "512", CLIARG_VISIBLE_DEFAULT, (void **) &sizeyout, NULL },
    { CLIARG_ONOFF, ".align.centered", "on if centered", "1", CLIARG_HIDDEN_DEFAULT,
      (void **) &centered, &fpi_centered },
    { CLIARG_FLOAT32, ".align.xcenter", "x axis center", "200", CLIARG_HIDDEN_DEFAULT,
      (void **) &xcent, NULL },
    { CLIARG_FLOAT32, ".align.ycenter", "y axis center", "200", CLIARG_HIDDEN_DEFAULT,
      (void **) &ycent, NULL },
    { CLIARG_FLOAT32, ".rCPAmin", "minimum radial cycle per aperture", "-1.0",
      CLIARG_HIDDEN_DEFAULT, (void **) &rCPAminval, NULL },
    { CLIARG_FLOAT32, ".rCPAmax", "maximum radial cycle per aperture", "1008.0",
      CLIARG_HIDDEN_DEFAULT, (void **) &rCPAmaxval, NULL },
    { CLIARG_FLOAT32, ".CPAmax", "maximum cycle per aperture", "8.0", CLIARG_VISIBLE_DEFAULT,
      (void **) &CPAmaxval, NULL },
    { CLIARG_FLOAT32, ".deltaCPA", "CPA interval", "0.8", CLIARG_VISIBLE_DEFAULT,
      (void **) &deltaCPAval, NULL },
    { CLIARG_FLOAT32, ".radius", "disk radius", "160.0", CLIARG_VISIBLE_DEFAULT,
      (void **) &radiusval, NULL },
    { CLIARG_FLOAT32, ".radfactlim", "radius factor limit", "1.5", CLIARG_VISIBLE_DEFAULT,
      (void **) &radiusfactorlimval, NULL },
    { CLIARG_FLOAT32, ".fpowerlaw", "frequency power law (amp x f^a)", "0", CLIARG_HIDDEN_DEFAULT,
      (void **) &fpowerlaw, NULL },
    { CLIARG_FLOAT32, ".fpowerlaw_minf", "frequency power law min freq", "1.0",
      CLIARG_HIDDEN_DEFAULT, (void **) &fpowerlaw_minf, NULL },
    { CLIARG_FLOAT32, ".fpowerlaw_maxf", "frequency power law max freq", "100.0",
      CLIARG_HIDDEN_DEFAULT, (void **) &fpowerlaw_maxf, NULL },
    { CLIARG_UINT32, ".writefile", "write file flag", "0", CLIARG_VISIBLE_DEFAULT,
      (void **) &writefileval, NULL },
    { CLIARG_IMG, ".maskim", "optional mask for extrapolation", "mask", CLIARG_HIDDEN_DEFAULT,
      (void **) &maskim, NULL },
    { CLIARG_FLOAT32, ".extrfactor", "extrapolation factor [radian]", "1.0", CLIARG_HIDDEN_DEFAULT,
      (void **) &extrfactor, NULL },
    { CLIARG_FLOAT32, ".extroffset", "extrapolation offset [pix]", "0.5", CLIARG_HIDDEN_DEFAULT,
      (void **) &extroffset, NULL }
};
...
static CLICMDDATA CLIcmddata = { "mkFouriermodes", "make basis of Fourier Modes",
            ...
            if (r < radfactlim)
            {
                ...
                if (MASKext == 1)
                {
                    ...
                    float afact0 = 1.0 + extroffset -
                                   pdist * sqrt(CPAx * CPAx + CPAy * CPAy) * M_PI / extrfactor;
                    if (afact0 > 1.0)
                    {
                        afact0 = 1.0;
                    }
