...
static CLICMDARGDEF farg[] = {
    { CLIARG_IMG, ".inim", "input vector", "imvec", CLIARG_VISIBLE_DEFAULT, (void **) &imvecname,
      NULL },
    { CLIARG_IMG, ".inpixi", "pixel index image", "pixi", CLIARG_VISIBLE_DEFAULT,
      (void **) &inpixiname, NULL },
    { CLIARG_IMG, ".inpixmult", "input pixel mult image", "pixmult", CLIARG_VISIBLE_DEFAULT,
      (void **) &inpixmultname, NULL },
    { CLIARG_STR, ".outim", "output 2D image", "outim", CLIARG_VISIBLE_DEFAULT,
      (void **) &outimname, NULL },
    { CLIARG_INT64, ".xsize", "X size", "512", CLIARG_VISIBLE_DEFAULT, (void **) &xsizein, NULL },
    { CLIARG_INT64, ".ysize", "Y size", "512", CLIARG_VISIBLE_DEFAULT, (void **) &ysizein, NULL }
};

static CLICMDDATA CLIcmddata = { "vec2im", "remap vector to image", CLICMD_FIELDS_DEFAULTS };
