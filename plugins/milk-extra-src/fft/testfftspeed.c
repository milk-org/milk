...
static FPS_APP_INFO FPS_app_info = {
    ...
    .description_long = "Benchmark FFTW performance for a given image size and transform type. "
                        "Measures throughput in megapixels/s and reports optimal plan wisdom."
};
