...
//
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".in_name", "input image cube", "imc1",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &farg_inimname, NULL },
                               { CLIARG_STR, ".outdname", "output directory name", "outd",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &farg_outdname, NULL },
                               { CLIARG_INT64, ".kNNsize", "number of samples in cluster", "20",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &farg_kNNsize, NULL } };
...
static errno_t compute_function()
{
    ...
    imcube_mindiffscan(mkIMGID_from_name(farg_inimname), farg_outdname, *farg_kNNsize);
