...
{
    RegisterCLIcommand("rotateim", __FILE__, image_basic_rotate_cli, "rotate 2D image",
                       "<image in> <output image> <angle>", "rotateim imin imout 230",
                      ...
                      float angle)
{
    ...
    for (uint32_t jj = 0; jj < naxes[1]; jj++)
    {
        for (uint32_t ii = 0; ii < naxes[0]; ii++)
        {
            ...
            data.image[ID_out].array.F[((long) y) * naxes2[0] + ((long) (x)) - 1] +=
            ...
            data.image[ID_out].array.F[((long) y + 1) * naxes2[0] + ((long) (x)) - 1] +=
                f4 * data.image[ID_in].array.F[jj * naxes[0] + ii];
            data.image[ID_out].array.F[((long) y + 1) * naxes2[0] + ((long) (x))] +=
                f5 * data.image[ID_in].array.F[jj * naxes[0] + ii];
            data.image[ID_out].array.F[((long) y + 1) * naxes2[0] + ((long) (x)) + 1] +=
                f6 * data.image[ID_in].array.F[jj * naxes[0] + ii];

            data.image[ID_out].array.F[((long) y + 2) * naxes2[0] + ((long) (x)) - 1] +=
                f7 * data.image[ID_in].array.F[jj * naxes[0] + ii];
            data.image[ID_out].array.F[((long) y + 2) * naxes2[0] + ((long) (x))] +=
