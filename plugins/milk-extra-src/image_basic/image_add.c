...
{
    if (CLI_checkarg(1, 4) + CLI_checkarg(2, 4) + CLI_checkarg(3, 3) + CLI_checkarg(4, 2) +
            CLI_checkarg(5, 2) + CLI_checkarg(6, 2) ==
        0)
    {
...
{
    RegisterCLIcommand("addim", __FILE__, image_basic_add_cli,
    ...
    RegisterCLIcommand(
        "addim3D", __FILE__, image_basic_add3D_cli, "add two 3D images of different size",
                            ...
                            if (((jj + ymin) >= 0) && ((jj + ymin) < naxes1[1]))
                            {
                                if (((kk + zmin) >= 0) && ((kk + zmin) < naxes1[2]))
                                {
                                    data.image[ID_out]
                                        ...
                                        data.image[ID1]
                                            .array.F[(kk + zmin) * naxes1[1] * naxes1[0] +
                            ...
                            if (((jj + ymin) >= 0) && ((jj + ymin) < naxes1[1]))
                            {
                                if (((kk + zmin) >= 0) && ((kk + zmin) < naxes1[2]))
                                {
                                    data.image[ID_out]
                                        ...
                                        data.image[ID1]
                                            .array.D[(kk + zmin) * naxes1[1] * naxes1[0] +
                                                     (jj + ymin) * naxes1[0] + (ii + xmin)];
                                }
                            }
                        }
