...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".modesA", "input modes A", "inmA",
                               ...
                               { CLIARG_IMG, ".modesB", "input modes B", "inmB",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &modesB, &fpi_modesB },
                               { CLIARG_STR, ".outcoeffA", "output coeffs A", "outcA",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outcoeffA, &fpi_outcoeffA },
                               { CLIARG_STR, ".outcoeffB", "output coeffs B", "outcB",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outcoeffB, &fpi_outcoeffB },
                               { CLIARG_STR, ".outimA", "output image A", "outcA",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outimA, &fpi_outimA },
                               { CLIARG_STR, ".outimB", "output image B", "outcB",
