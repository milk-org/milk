                               ...
                               long        loopnb)
{
    ...
    if (gpumatmultconf[index].init == 0)
    {
        ...
        if (orientation == 0)
        {
            if (dcimg[IDcontrM].md[0].naxis == 3)
            {
                ...
                gpumatmultconf[index].N =
                    dcimg[IDcontrM].md[0].size[0] * dcimg[IDcontrM].md[0].size[1];
                //   cmatdim = 3;
            }
            else
            {
        ...
        if (orientation == 0)
        {
            ...
            if ((uint32_t) (dcimg[IDwfsim].md[0].size[0] * dcimg[IDwfsim].md[0].size[1]) !=
                gpumatmultconf[index].N)
            {
                PRINT_ERROR("CONTRmat and WFSvec size not compatible: %ld vs %d\n",
                            (long) (dcimg[IDwfsim].md[0].size[0] * dcimg[IDwfsim].md[0].size[1]),
        ...
        else
        {
            ...
            if (dcimg[IDwfsim].md[0].size[0] != gpumatmultconf[index].N)
            {
                printf("ERROR: CONTRmat and WFSvec size not compatible: %ld %d\n",
                       (long) dcimg[IDwfsim].md[0].size[0], (int) gpumatmultconf[index].N);
                fflush(stdout);
                sleep(2);
                exit(0);
            }
        ...
        {
            {
                IMGID imgout         = imgid_make_from_name(IDoutdmmodes_name);
                imgout.mdt->naxis    = 2;
                imgout.mdt->size[0]  = gpumatmultconf[index].M;
                imgout.mdt->size[1]  = 1;
                ...
                gpumatmultconf[index].IDout = imgout.ID;
            }
        }
        else
        {
            if ((uint32_t) (dcimg[gpumatmultconf[index].IDout].md[0].size[0] *
                            dcimg[gpumatmultconf[index].IDout].md[0].size[1]) !=
                gpumatmultconf[index].M)
            {
                printf("ERROR: CONTRmat and WFSvec size not compatible: %ld %d\n",
                       (long) (dcimg[gpumatmultconf[index].IDout].md[0].size[0] *
                               dcimg[gpumatmultconf[index].IDout].md[0].size[1]),
        ...
        gpumatmultconf[index].dmVecTMP = dcimg[gpumatmultconf[index].IDout].array.F;

        // This section will create a thread

        pthread_t GPUscan_thread;

        pthread_create(&GPUscan_thread, NULL, GPU_scanDevices, (void *) &cuda_deviceCount);
        ...
        for (int device = 1; device < gpumatmultconf[index].NBstreams; device++)
        {
            gpumatmultconf[index].Noffset[device] =
                ...
                (long) (gpumatmultconf[index].N / gpumatmultconf[index].NBstreams);
            gpumatmultconf[index].Nsize[device - 1] =
                gpumatmultconf[index].Noffset[device] - gpumatmultconf[index].Noffset[device - 1];
        }
        gpumatmultconf[index].Nsize[gpumatmultconf[index].NBstreams - 1] =
            gpumatmultconf[index].N -
            gpumatmultconf[index].Noffset[gpumatmultconf[index].NBstreams - 1];

        printf("Allocating physical GPU(s) to stream(s) (index %d, NBGPU(s) = "
               "%ld)\n",
               index, NBGPUs);
        ...
        {
            printf(
                "DEVICE %2d  [%2d]:  %5d -> %5d  (%d)\n", device,
                gpumatmultconf[index].GPUdevice[device],
                (int) gpumatmultconf[index].Noffset[device],
                (int) (gpumatmultconf[index].Noffset[device] + gpumatmultconf[index].Nsize[device]),
        ...
        // device (GPU)
        gpumatmultconf[index].d_cMat =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams);
        ...
        gpumatmultconf[index].d_wfsRef =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams); // WFS reference
        ...
        gpumatmultconf[index].d_dmRef =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams); // DM reference
        ...
        gpumatmultconf[index].stream =
            (cudaStream_t *) malloc(sizeof(cudaStream_t) * gpumatmultconf[index].NBstreams);
        ...
        gpumatmultconf[index].handle =
            (cublasHandle_t *) malloc(sizeof(cublasHandle_t) * gpumatmultconf[index].NBstreams);
        ...
        // host (computer)
        gpumatmultconf[index].cMat_part =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams);
        ...
        gpumatmultconf[index].wfsVec_part =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams);
        ...
        gpumatmultconf[index].dmVec_part =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams);
        ...
        gpumatmultconf[index].wfsRef_part =
            (float **) malloc(sizeof(float *) * gpumatmultconf[index].NBstreams); // WFS reference
        ...
        gpumatmultconf[index].dmRef_part = (float **) malloc(
            sizeof(float *) * gpumatmultconf[index].NBstreams); // DM reference (for checking only)
        ...
        gpumatmultconf[index].semptr1 =
            (sem_t **) malloc(sizeof(sem_t *) * gpumatmultconf[index].NBstreams);
        ...
        for (int device = 0; device < gpumatmultconf[index].NBstreams; device++)
        {
            gpumatmultconf[index].cMat_part[device] = (float *) malloc(
            ...
            gpumatmultconf[index].wfsVec_part[device] =
                (float *) malloc(sizeof(float) * gpumatmultconf[index].Nsize[device]);
            ...
            snprintf(sname, sizeof(sname), "loop%02ld_i%02d_gpu%02d_sem1_%06d", loopnb, index,
                     GPUdevice[device], pid);
            if ((gpumatmultconf[index].semptr1[device] = sem_open(sname, O_CREAT, 0644, 1)) ==
                SEM_FAILED)
            {
            ...
            snprintf(sname, sizeof(sname), "loop%02ld_i%02d_gpu%02d_sem2_%06d", loopnb, index,
                     GPUdevice[device], pid);
            if ((gpumatmultconf[index].semptr2[device] = sem_open(sname, O_CREAT, 0644, 1)) ==
                SEM_FAILED)
            {
                perror("semaphore initilization");
                exit(0);
            ...
            snprintf(sname, sizeof(sname), "loop%02ld_i%02d_gpu%02d_sem3_%06d", loopnb, index,
                     GPUdevice[device], pid);
            if ((gpumatmultconf[index].semptr3[device] = sem_open(sname, O_CREAT, 0644, 1)) ==
                SEM_FAILED)
            {
                perror("semaphore initilization");
                exit(0);
            ...
            snprintf(sname, sizeof(sname), "loop%02ld_i%02d_gpu%02d_sem4_%06d", loopnb, index,
                     GPUdevice[device], pid);
            if ((gpumatmultconf[index].semptr4[device] = sem_open(sname, O_CREAT, 0644, 1)) ==
                SEM_FAILED)
            {
                perror("semaphore initilization");
                exit(0);
            ...
            snprintf(sname, sizeof(sname), "loop%02ld_i%02d_gpu%02d_sem5_%06d", loopnb, index,
                     GPUdevice[device], pid);
            if ((gpumatmultconf[index].semptr5[device] = sem_open(sname, O_CREAT, 0644, 1)) ==
                SEM_FAILED)
            {
                perror("semaphore initilization");
                exit(0);
        ...
        for (int device = 0; device < gpumatmultconf[index].NBstreams; device++)
        {
            ...
            cudaError_t error = cudaMalloc((void **) &gpumatmultconf[index].d_cMat[device],
            ...
            cublasStatus_t stat = cublasCreate(&gpumatmultconf[index].handle[device]);
        ...
        for (int device = 0; device < gpumatmultconf[index].NBstreams; device++)
        {
                 ...
                 n++)
            {
                gpumatmultconf[index]
                    .wfsVec_part[device][n - gpumatmultconf[index].Noffset[device]] =
                    gpumatmultconf[index].wfsVec[n];
                gpumatmultconf[index]
                    .wfsRef_part[device][n - gpumatmultconf[index].Noffset[device]] =
        ...
        for (int device = 0; device < gpumatmultconf[index].NBstreams; device++)
        {
            cudaError_t error = cudaMemcpy(
                gpumatmultconf[index].d_wfsVec[device], gpumatmultconf[index].wfsVec_part[device],
            ...
            fflush(stdout);
            error = cudaMemcpy(
                gpumatmultconf[index].d_wfsRef[device], gpumatmultconf[index].wfsRef_part[device],
                sizeof(float) * gpumatmultconf[index].Nsize[device], cudaMemcpyHostToDevice);
            if (error != cudaSuccess)
            {
                printf("cudaMemcpy d_wfsRef wfsRef returned error code %d, "
                       "line(%d)\n",
                       error, __LINE__);
                exit(EXIT_FAILURE);
            }
        ...
        gpumatmultconf[index].threadarray =
            (pthread_t *) malloc(sizeof(pthread_t) * gpumatmultconf[index].NBstreams);
