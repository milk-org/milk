...
#ifdef HAVE_BLAS
void matrixMulCPU_BLAS(float *restrict cMat,
...
void matrixMulCPU_plain_or_OPENMP(float *restrict cMat,
                                  float *restrict wfsVec,
                                  float *restrict dmVec,
                                  int M,
                                  int N)
...
{
#ifdef HAVE_BLAS
    matrixMulCPU_BLAS(cMat, wfsVec, dmVec, M, N);
#else
    matrixMulCPU_plain_or_OPENMP(cMat, wfsVec, dmVec, M, N);
