...
static CLICMDARGDEF farg[] = {
    { // input
      CLIARG_IMG, ".inM", "input matrix", "inM", CLIARG_VISIBLE_DEFAULT, (void **) &inM, &fpi_inM },
    { // output U
      CLIARG_STR, ".outU", "output U", "outU", CLIARG_VISIBLE_DEFAULT, (void **) &outU, &fpi_outU },
    { CLIARG_STR, ".outS", "output ingular values", "outS", CLIARG_VISIBLE_DEFAULT, (void **) &outS,
      &fpi_outS },
    { // output V
      CLIARG_STR, ".outV", "output V", "outV", CLIARG_VISIBLE_DEFAULT, (void **) &outV, &fpi_outV },
    { CLIARG_UINT32, ".Vdim0", "first dimension of V if 3D, 0 if 2D", "0", CLIARG_HIDDEN_DEFAULT,
      (void **) &Vdim0, &fpi_Vdim0 },
    { // Singular Value Decomposition limit
      CLIARG_FLOAT32, ".svdlim", "SVD limit", "0.01", CLIARG_VISIBLE_DEFAULT, (void **) &svdlim,
      &fpi_svdlim },
    { CLIARG_UINT32, ".maxNBmode", "Maximum number of modes", "10000", CLIARG_HIDDEN_DEFAULT,
      (void **) &maxNBmode, &fpi_maxNBmode },
    { // using GPU (99 : no GPU, otherwise GPU device)
      CLIARG_INT32, ".GPUdevice", "GPU device, 99 for CPU", "-1", CLIARG_HIDDEN_DEFAULT,
      (void **) &GPUdevice, &fpi_GPUdevice },
    { // optional computations
      CLIARG_UINT64, ".compmode", "flag: optional computations and checks", "0",
      CLIARG_HIDDEN_DEFAULT, (void **) &compmode, &fpi_compmode }
};
...
static errno_t customCONFsetup()
{
    if (data.fpsptr != NULL)
    {
        data.fpsptr->parray[fpi_inM].fpflag |= FPFLAG_STREAM_RUN_REQUIRED | FPFLAG_CHECKSTREAM;
    }
...
static CLICMDDATA CLIcmddata = { "compSVD", "compute SVD", CLICMD_FIELDS_DEFAULTS };
...
static errno_t help_function()
{
    ...
    printf("\n");
    printf("To run PCA on a sequence of images, input should be 3D cube of "
           "images\n");
                    ...
                    char    *SVDvnmodesname)
{
    ...
    long   NBmode = 0;
    {
        ...
        //
        // memcpy(imgmNsvec->im->array.F, imgATA.im->array.F,
