...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".inmodes", "input modes", "inm",
                               ...
                               { CLIARG_STR, ".outmodes", "output modes", "outm",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &outmodes, &fpi_outmodes },
                               { CLIARG_STR, ".auxmat", "optional aux matrix, co-transformed",
                                 "auxmat", CLIARG_HIDDEN_DEFAULT, (void **) &auxmat, &fpi_auxmat },
