...
static CLICMDARGDEF farg[] = {
    ...
    { CLIARG_IMG, ".inU0", "input space mode", "inU0", CLIARG_VISIBLE_DEFAULT, (void **) &inU0,
      &fpi_inU0 },
    { CLIARG_IMG, ".inU1", "output space mode", "inU1", CLIARG_VISIBLE_DEFAULT, (void **) &inU1,
      &fpi_inU1 },
    { CLIARG_STR, ".outM", "output M", "outM", CLIARG_VISIBLE_DEFAULT, (void **) &outM, &fpi_outM },
