...
static errno_t gauss_filter_cli()
{
    ...
    {
        gauss_filter(data.cmdargtoken[1].val.string, data.cmdargtoken[2].val.string,
                     ...
                     int   filter_size)
{
    ...
    for (uint32_t k = 0; k < naxes[2]; k++)
    {
        ...
        for (uint32_t jj = 0; jj < naxes[1]; jj++)
        {
            ...
            for (uint32_t ii = 0; ii < filtersizec; ii++)
            {
                ...
                for (int i = filtersizec - ii; i < (2 * filtersizec + 1); i++)
                {
                    data.image[IDtmp].array.F[jj * naxes[0] + ii] +=
                        array[i] * data.image[ID].array.F[k * naxes[0] * naxes[1] + jj * naxes[0] +
                                                          (ii - filtersizec + i)];
                    tot += array[i];
                }
            ...
            {
                double tot = 0.0;
                for (int i = 0; i < (2 * filtersizec + 1) - (ii - naxes[0] + filtersizec + 1); i++)
                {
                    data.image[IDtmp].array.F[jj * naxes[0] + ii] +=
                        array[i] * data.image[ID].array.F[k * naxes[0] * naxes[1] + jj * naxes[0] +
                                                          (ii - filtersizec + i)];
        ...
        for (uint32_t ii = 0; ii < naxes[0]; ii++)
        {
            for (long jj = 0; jj < naxes[1] - (2 * filtersizec + 1); jj++)
            {
                ...
                {
                    data.image[IDout]
                        .array.F[k * naxes[0] * naxes[1] + (jj + filtersizec) * naxes[0] + ii] +=
            ...
            for (long jj = 0; jj < filtersizec; jj++)
            {
                ...
                for (int j = filtersizec - jj; j < jmax; j++)
                {
                    data.image[IDout].array.F[k * naxes[0] * naxes[1] + jj * naxes[0] + ii] +=
                        array[j] *
                        data.image[IDtmp].array.F[(jj - filtersizec + j) * naxes[0] + ii];
                    tot += array[j];
                }
            ...
            {
                double tot = 0.0;
                for (int j = 0; j < (2 * filtersizec + 1) - (jj - naxes[1] + filtersizec + 1); j++)
                {
                    data.image[IDout].array.F[k * naxes[0] * naxes[1] + jj * naxes[0] + ii] +=
                        array[j] *
                        data.image[IDtmp].array.F[(jj - filtersizec + j) * naxes[0] + ii];
    ...
    for (long kk = 0; kk < naxes[2]; kk++)
    {
        for (long jj = 0; jj < naxes[1]; jj++)
        {
            for (long ii = 0; ii < naxes[0] - (2 * filter_size + 1); ii++)
            {
                ...
                {
                    data.image[IDtmp]
                        .array.F[kk * naxes[0] * naxes[1] + jj * naxes[0] + (ii + filter_size)] +=
                        array[i] *
                        data.image[ID].array.F[kk * naxes[0] * naxes[1] + jj * naxes[0] + (ii + i)];
                }
            }
        }
    }
    ...
    for (long kk = 0; kk < naxes[2]; kk++)
    {
        for (long ii = 0; ii < naxes[0]; ii++)
        {
            for (long jj = 0; jj < naxes[1] - (2 * filter_size + 1); jj++)
            {
                ...
                {
                    data.image[IDtmp1]
                        .array.F[kk * naxes[0] * naxes[1] + (jj + filter_size) * naxes[0] + ii] +=
                        array[j] *
                        data.image[IDtmp]
                            .array.F[kk * naxes[0] * naxes[1] + (jj + j) * naxes[0] + ii];
                }
            }
        }
    }
    ...
    for (long ii = 0; ii < naxes[0]; ii++)
    {
        for (long jj = 0; jj < naxes[1]; jj++)
        {
            for (long kk = 0; kk < naxes[2] - (2 * filter_size + 1); kk++)
            {
                ...
                {
                    data.image[IDout]
                        .array.F[(kk + filter_size) * naxes[0] * naxes[1] + jj * naxes[0] + ii] +=
                        array[k] *
                        data.image[IDtmp1]
                            .array.F[(kk + k) * naxes[0] * naxes[1] + jj * naxes[0] + ii];
                }
            }
        }
    }
