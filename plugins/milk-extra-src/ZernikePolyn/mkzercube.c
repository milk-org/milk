...
static CLICMDARGDEF farg[] = {
    { // zonal RM WFS
      CLIARG_STR, ".outimg", "output image name", "zerc", CLIARG_VISIBLE_DEFAULT,
      (void **) &outzcubename, &fpi_outzcubename },
    { CLIARG_UINT32, ".xsize", "X size", "50", CLIARG_VISIBLE_DEFAULT, (void **) &xsize,
      &fpi_xsize },
    { CLIARG_UINT32, ".ysize", "Y size", "50", CLIARG_VISIBLE_DEFAULT, (void **) &ysize,
      &fpi_ysize },
    { CLIARG_FLOAT32, ".xcent", "X center", "24.5", CLIARG_VISIBLE_DEFAULT, (void **) &xcent,
      &fpi_xcent },
    { CLIARG_FLOAT32, ".ycent", "Y center", "24.5", CLIARG_VISIBLE_DEFAULT, (void **) &ycent,
      &fpi_ycent },
    { CLIARG_FLOAT32, ".rad", "radius", "24.5", CLIARG_VISIBLE_DEFAULT, (void **) &radius,
      &fpi_radius },
    { CLIARG_FLOAT32, ".radmaskfact", "masking radius factor", "1.2", CLIARG_HIDDEN_DEFAULT,
      (void **) &radiusmaskfactor, &fpi_radiusmaskfactor },
    { CLIARG_FLOAT32, ".TTfactor", "amplitude factor on TTr", "1.0", CLIARG_HIDDEN_DEFAULT,
      (void **) &TTfactor, &fpi_TTfactor },
    { CLIARG_UINT32, ".NBzermode", "Number modes", "5", CLIARG_VISIBLE_DEFAULT,
