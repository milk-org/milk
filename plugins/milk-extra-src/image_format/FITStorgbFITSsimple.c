    ...
    if (FastMode == 0)
    {
        ...
        if (IDbias != -1)
        {
            for (ii = 0; ii < Xsize; ii++)
            {
                ...
                {
                    dcimg[ID].array.F[jj * Xsize + ii] -= dcimg[IDbias].array.F[jj * Xsize + ii];
                }
            }
        }
        // remove dark
        if (IDdark != -1)
        {
            for (ii = 0; ii < Xsize; ii++)
            {
                for (jj = 0; jj < Ysize; jj++)
                {
                    dcimg[ID].array.F[jj * Xsize + ii] -= dcimg[IDdark].array.F[jj * Xsize + ii];
                }
            }
        }
                        ...
                        for (dii = -2; dii < 3; dii++)
                        {
                            for (djj = -2; djj < 3; djj++)
                            {
                                ...
                                if ((ii1 > -1) && (jj1 > -1) && (ii1 < Xsize) && (jj1 < Ysize))
                                {
                                    if ((dii != 0) || (djj != 0))
                                    {
                                        if (dcimg[IDrc].array.F[jj1 * Xsize + ii1] > 0.5)
                                        {
                                            coeff = exp(-5.0 * (dii * dii + djj * djj));
                                            vc += coeff;
                                            v += dcimg[IDr].array.F[jj1 * Xsize + ii1] * coeff;
                                        }
                                    }
                                }
                            }
                        ...
                        for (dii = -2; dii < 3; dii++)
                        {
                            for (djj = -2; djj < 3; djj++)
                            {
                                ...
                                if ((ii1 > -1) && (jj1 > -1) && (ii1 < Xsize) && (jj1 < Ysize))
                                {
                                    if ((dii != 0) || (djj != 0))
                                    {
                                        if (dcimg[IDgc].array.F[jj1 * Xsize + ii1] > 0.5)
                                        {
                                            coeff = exp(-5.0 * (dii * dii + djj * djj));
                                            vc += coeff;
                                            v += dcimg[IDg].array.F[jj1 * Xsize + ii1] * coeff;
                                        }
                                    }
                                }
                            }
                        ...
                        for (dii = -2; dii < 3; dii++)
                        {
                            for (djj = -2; djj < 3; djj++)
                            {
                                ...
                                if ((ii1 > -1) && (jj1 > -1) && (ii1 < Xsize) && (jj1 < Ysize))
                                {
                                    if ((dii != 0) || (djj != 0))
                                    {
                                        if (dcimg[IDbc].array.F[jj1 * Xsize + ii1] > 0.5)
                                        {
                                            coeff = exp(-5.0 * (dii * dii + djj * djj));
                                            vc += coeff;
                                            v += dcimg[IDb].array.F[jj1 * Xsize + ii1] * coeff;
                                        }
                                    }
                                }
                            }
            ...
            if (RGBmode == 1) // GBRG
            {
                ...
                for (ii1 = 0; ii1 < Xsize / 2 - 1; ii1++)
                {
                    for (jj1 = 1; jj1 < Ysize / 2; jj1++)
                    {
                        ...
                        jj2 = jj;
                        dcimg[IDg].array.F[jj2 * Xsize + ii2] =
                            0.25 * (dcimg[ID].array.F[jj2 * Xsize + (ii2 - 1)] +
                ...
                for (ii1 = 0; ii1 < Xsize / 2; ii1++)
                {
                    for (jj1 = 1; jj1 < Ysize / 2; jj1++)
                    {
                        ...
                        jj2 = jj;
                        dcimg[IDr].array.F[jj2 * Xsize + ii2] =
                            0.5 * (dcimg[ID].array.F[(jj2 - 1) * Xsize + ii2] +
                                   dcimg[ID].array.F[(jj2 + 1) * Xsize + ii2]);
                    }
                }
                // replace g2 pixels
                for (ii1 = 0; ii1 < Xsize / 2 - 1; ii1++)
                {
                    for (jj1 = 0; jj1 < Ysize / 2; jj1++)
                    {
                        ...
                        jj2 = jj + 1;
                        dcimg[IDr].array.F[jj2 * Xsize + ii2] =
                            0.5 * (dcimg[ID].array.F[jj2 * Xsize + (ii2 - 1)] +
                                   dcimg[ID].array.F[jj2 * Xsize + (ii2 + 1)]);
                    }
                }
                // replace b pixels
                for (ii1 = 0; ii1 < Xsize / 2 - 1; ii1++)
                {
                    for (jj1 = 1; jj1 < Ysize / 2; jj1++)
                    {
                        ...
                        jj2 = jj;
                        dcimg[IDr].array.F[jj2 * Xsize + ii2] =
                            0.25 * (dcimg[ID].array.F[(jj2 - 1) * Xsize + (ii2 - 1)] +
                                    dcimg[ID].array.F[(jj2 - 1) * Xsize + (ii2 + 1)] +
                                    dcimg[ID].array.F[(jj2 + 1) * Xsize + (ii2 - 1)] +
                                    dcimg[ID].array.F[(jj2 + 1) * Xsize + (ii2 + 1)]);
                    }
                }
        ...
        for (ii1 = 0; ii1 < Xsize / 2; ii1++)
        {
            for (jj1 = 0; jj1 < Ysize / 2; jj1++)
            {
                ...
                dcimg[ID01].array.F[jj1 * Xsize / 2 + ii1] +=
                    dcimg[ID].array.F[jj2 * Xsize + ii2] / dcimg[IDflat].array.F[jj2 * Xsize + ii2];
