...
static CLICMDARGDEF farg[] = { { CLIARG_IMG, ".in_name", "input image", "in_name",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &in_name, NULL },
                               { CLIARG_INT32, ".n_frames", "Stats every n frames max", "n_frames",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &ptr_n_frames, NULL },
                               { CLIARG_FLOAT64, ".timeout", "Stats at timeout (sec)", "timeout",
                                 CLIARG_VISIBLE_DEFAULT, (void **) &ptr_timeout, NULL } };

static CLICMDDATA CLIcmddata = { "stream_av_std", "RT compute of ave/std of image streams",
