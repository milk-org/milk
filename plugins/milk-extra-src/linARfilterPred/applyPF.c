...
static CLICMDARGDEF farg[] = {
    { // AO loop index - used for automatic naming of streams aolX_
      CLIARG_UINT64, ".AOloopindex", "AO loop index", "0", CLIARG_VISIBLE_DEFAULT,
      (void **) &AOloopindex, NULL },
    { // Input stream
      CLIARG_STREAM, ".indata", "input data stream", "inim", CLIARG_VISIBLE_DEFAULT,
      (void **) &indata, NULL },
    { // Input stream active mask
      CLIARG_STREAM, ".inmask", "input data mask", "inmask", CLIARG_VISIBLE_DEFAULT,
      (void **) &inmask, NULL },
    { // Prediction filter matrix
      CLIARG_STREAM, ".PFmat", "predictive filter matrix", "PFmat", CLIARG_VISIBLE_DEFAULT,
      (void **) &PFmat, NULL },
    { // Output stream
      CLIARG_STREAM, ".outdata", "output data stream", "outPF", CLIARG_VISIBLE_DEFAULT,
      (void **) &outdata, NULL },
    { // Output mask
      CLIARG_STREAM, ".outmask", "output data mask", "outmask", CLIARG_VISIBLE_DEFAULT,
      (void **) &outmask, NULL },
    { // Output update
      CLIARG_STR, ".outPFstat", "output PF stats image", "outPFstat", CLIARG_VISIBLE_DEFAULT,
      (void **) &outPFstat, NULL },
    { // Set of GPU(s) for computation
      CLIARG_STR, ".GPUset", "column-separated list of GPUs", ":0:", CLIARG_HIDDEN_DEFAULT,
      (void **) &GPUsetstr, &fpi_GPUsetstr },
    { // compute residual mismatch
      CLIARG_ONOFF, ".comp.residual", "compute residual mismatch", "0", CLIARG_HIDDEN_DEFAULT,
      (void **) &compOLresidual, &fpi_compOLresidual },
    { // Set of GPU(s) for computation
      CLIARG_UINT32, ".comp.OLresidualNBpt", "sampling size for OL residual", "1000",
