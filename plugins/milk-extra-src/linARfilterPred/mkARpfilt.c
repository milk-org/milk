...
static MILK_HOT errno_t fpsexec()
{
    LINARFILTERPRED_Build_LinPredictor(
        param_in_name, (long)param_pforder,
        (float)param_pflag, param_svdeps, param_reglambda,
        param_out_name, 1,
        (int)param_loopmode,
        (float)param_loopgain, (int)param_testmode);
