...
#define PROCESSOR_PARAMS(X)                                                                       \
    X(FPTYPE_STRING, char *, ".in_name", "Input Stream Name", "stream03", "stream03",             \
      &in_name_ptr, (FPFLAG_DEFAULT_INPUT | FPFLAG_CLI_INPUT))                                    \
    X(FPTYPE_STRING, char *, ".out_name", "Output Stream Name", "stream03_proc", "stream03_proc", \
      &proc_out_name_ptr, (FPFLAG_DEFAULT_INPUT | FPFLAG_CLI_INPUT))                              \
    X(FPTYPE_UINT32, uint32_t, ".roi_size", "ROI Size", "50", 50, &roi_size_ptr,                  \
      (FPFLAG_DEFAULT_INPUT | FPFLAG_CLI_INPUT))                                                  \
    X(FPTYPE_UINT32, uint32_t, ".off_x", "Offset X", "0", 0, &off_x_ptr,                          \
      (FPFLAG_DEFAULT_INPUT | FPFLAG_CLI_INPUT))
