...
int fps_value_to_key(pyFps &cls, const std::string &key, const FPS_type fps_type, py::object value)
{
    ...
    case FPS_type::STRING:
        return functionparameter_SetParamValue_STRING(cls, key.c_str(), std::string(py::str(value)).c_str());
    default:
        return EXIT_FAILURE;
    }
}
...
Return:
    ret : error code
        ...
        .def_property(
            ...
            [](pyProcessInfo &p, std::string name) { strncpy(p->name, name.c_str(), sizeof(p->name)); },
        ...
        .def_property(
            "PID", [](pyProcessInfo &p) { return p->PID; }, [](pyProcessInfo &p, int PID) { p->PID = PID; })
        ...
        .def_property(
            ...
            [](pyProcessInfo &p, std::string name) { strncpy(p->tmuxname, name.c_str(), sizeof(p->tmuxname)); })
        .def_property(
        ...
        .def_property(
            ...
            [](pyProcessInfo &p, std::string name) { strncpy(p->statusmsg, name.c_str(), sizeof(p->statusmsg)); })
        .def_property(
        ...
        .def_property(
            ...
            [](pyProcessInfo &p, std::string name) { strncpy(p->description, name.c_str(), sizeof(p->description)); });
...
Parameters:
    ...
    NBparamMAX   [in]:  Max number of parameters
        ...
        .def("__getitem__",
             [](pyFps &cls, const std::string &key) { return fps_value_from_key(cls, key, cls.keys(key)); })

        .def("__setitem__", [](pyFps &cls, const std::string &key,
                               py::object value) { return fps_value_to_key(cls, key, cls.keys(key), value); })
...
Parameters:
    ...
    NBparamMAX   [in]:  Max number of parameters
        ...
        .def(
            "get_param_value_int",
            [](pyFps &cls, std::string key) { return functionparameter_GetParamValue_INT64(cls, key.c_str()); },
...
Return:
    ret      [out]: parameter value
        ...
        .def(
            ...
            [](pyFps &cls, std::string key) { return functionparameter_GetParamValue_FLOAT32(cls, key.c_str()); },
...
Return:
    ret      [out]: parameter value
        ...
        .def(
            ...
            [](pyFps &cls, std::string key) { return functionparameter_GetParamValue_FLOAT64(cls, key.c_str()); },
...
Return:
    ret      [out]: error code
        ...
        .def(
            ...
            [](pyFps &cls, std::string key, std::string value) {
                return functionparameter_SetParamValue_FLOAT32(cls, key.c_str(), std::stol(value));
            },
...
Return:
    ret      [out]: error code
        ...
        .def(
            ...
            [](pyFps &cls, std::string key, std::string value) {
                return functionparameter_SetParamValue_FLOAT64(cls, key.c_str(), std::stol(value));
            },
