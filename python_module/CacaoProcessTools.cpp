...
int fps_value_to_key(pyFps &cls, const std::string &key, const FPS_type fps_type, py::object value)
{
    ...
    {
    case FPS_type::ONOFF:
        return functionparameter_SetParamValue_ONOFF(cls, key.c_str(), py::bool_(value));
    case FPS_type::INT32:
    case FPS_type::UINT32:
    case FPS_type::INT64:
        return functionparameter_SetParamValue_INT64(cls, key.c_str(), py::int_(value));
    case FPS_type::UINT64:
        return functionparameter_SetParamValue_UINT64(cls, key.c_str(), py::int_(value));
    case FPS_type::FLOAT32:
        return functionparameter_SetParamValue_FLOAT32(cls, key.c_str(), py::float_(value));
    case FPS_type::FLOAT64:
        return functionparameter_SetParamValue_FLOAT64(cls, key.c_str(), py::float_(value));
...
py::object fps_value_from_key(pyFps &cls, const std::string &key, const FPS_type fps_type)
{
    switch (fps_type)
    {
    case FPS_type::ONOFF:
    ...
    case FPS_type::UINT64:
        return py::int_(functionparameter_GetParamValue_UINT64(cls, key.c_str()));
    case FPS_type::FLOAT32:
        return py::float_(functionparameter_GetParamValue_FLOAT32(cls, key.c_str()));
    case FPS_type::FLOAT64:
        return py::float_(functionparameter_GetParamValue_FLOAT64(cls, key.c_str()));
    case FPS_type::STRING:
    case FPS_type::STREAMNAME:
    case FPS_type::DIRNAME:
    case FPS_type::EXECFILENAME:
...
py::dict fps_to_dict(pyFps &cls)
{
    ...
    {
        fps_dict[py::str(key.first)] = fps_value_from_key(cls, key.first, key.second);
    }
    return fps_dict;
}
...
PYBIND11_MODULE(CacaoProcessTools, m)
{
    ...
    m.def("fparamCTRL", &functionparameter_CTRLscreen,
          ...
          py::arg("mode"), py::arg("fpsnamemask"), py::arg("fpsCTRLfifoname"),
...
Return:
    ret : error code
        ...
        .def_property(
            ...
            { strncpy(p->name, name.c_str(), sizeof(p->name)); }, "Name of the Process Info object")

        .def_property(
            "source_FUNCTION", [](pyProcessInfo &p) { return std::string(p->source_FUNCTION); },
            [](pyProcessInfo &p, std::string source_FUNCTION)
            { strncpy(p->source_FUNCTION, source_FUNCTION.c_str(), sizeof(p->source_FUNCTION)); })

        .def_property(
            "source_FILE", [](pyProcessInfo &p) { return std::string(p->source_FILE); },
            [](pyProcessInfo &p, std::string source_FILE)
            { strncpy(p->source_FILE, source_FILE.c_str(), sizeof(p->source_FILE)); })
        .def_property(
            "source_LINE", [](pyProcessInfo &p) { return p->source_LINE; },
            [](pyProcessInfo &p, int source_LINE) { p->source_LINE = source_LINE; })
        .def_property(
        ...
        .def_property(
            ...
            [](pyProcessInfo &p, timespec createtime) { p->createtime = createtime; })
        .def_property(
        ...
        .def_property(
            "statusmsg", [](pyProcessInfo &p) { return std::string(p->statusmsg); },
            [](pyProcessInfo &p, std::string name)
        ...
        .def_property(
            "description", [](pyProcessInfo &p) { return std::string(p->description); },
            [](pyProcessInfo &p, std::string name)
...
Parameters:
    ...
    NBparamMAX   [in]:  Max number of parameters
        ...
        .def("__getitem__", [](pyFps &cls, const std::string &key)
             { return fps_value_from_key(cls, key, cls.keys(key)); })

        .def("__setitem__", [](pyFps &cls, const std::string &key, py::object value)
...
Parameters:
    ...
    fptype   [in]:  datatype
        ...
        .def("add_entry", &pyFps::add_entry_w_flags,
...
Parameters:
    ...
    fpflag   [in]:  fps flags
             ...
             py::arg("entry_name"), py::arg("entry_desc"), py::arg("fptype"), py::arg("fpflag"))
        ...
        .def(
            "get_param_value_onoff", [](pyFps &cls, std::string key)
...
Return:
    ret      [out]: parameter value
        ...
        .def(
            "get_param_value_int", [](pyFps &cls, std::string key)
...
Return:
    ret      [out]: parameter value
        ...
        .def(
            "get_param_value_float", [](pyFps &cls, std::string key)
...
Return:
    ret      [out]: parameter value
            ...
            py::arg("key"))
        .def(
            "get_param_value_double", [](pyFps &cls, std::string key)
...
Return:
    ret      [out]: parameter value
            ...
            py::arg("key"))
        .def(
            "get_param_value_string", [](pyFps &cls, std::string key)
            { return std::string(functionparameter_GetParamPtr_STRING(cls, key.c_str())); },
...
Return:
    ret      [out]: parameter value
            ...
            py::arg("key"))
        .def(
            "set_param_value_onoff", [](pyFps &cls, std::string key, std::string value)
            { return functionparameter_SetParamValue_ONOFF(cls, key.c_str(), std::stol(value)); },
...
Return:
    ret      [out]: error code
        ...
        .def(
            "set_param_value_int", [](pyFps &cls, std::string key, std::string value)
            { return functionparameter_SetParamValue_INT64(cls, key.c_str(), std::stol(value)); },
...
Return:
    ret      [out]: error code
            ...
            py::arg("key"), py::arg("value"))
        .def(
            "set_param_value_float", [](pyFps &cls, std::string key, std::string value)
            { return functionparameter_SetParamValue_FLOAT32(cls, key.c_str(), std::stof(value)); },
...
Return:
    ret      [out]: error code
            ...
            py::arg("key"), py::arg("value"))
        .def(
            "set_param_value_double", [](pyFps &cls, std::string key, std::string value)
            { return functionparameter_SetParamValue_FLOAT64(cls, key.c_str(), std::stod(value)); },
...
Return:
    ret      [out]: error code
            ...
            py::arg("key"), py::arg("value"))
        .def(
            "set_param_value_string", [](pyFps &cls, std::string key, std::string value)
            { return functionparameter_SetParamValue_STRING(cls, key.c_str(), value.c_str()); },
...
Return:
    ret      [out]: error code
        ...
        .def("signal_update", &pyFps::signal_update,
...
Return:
    ...
    py::class_<FUNCTION_PARAMETER_STRUCT_MD>(m, "FPS_md")
        ...
        .def_readonly("confpidstarttime", &FUNCTION_PARAMETER_STRUCT_MD::confpidstarttime)
        .def_readonly("runpid", &FUNCTION_PARAMETER_STRUCT_MD::runpid)
        .def_readonly("runpidstarttime", &FUNCTION_PARAMETER_STRUCT_MD::runpidstarttime)
